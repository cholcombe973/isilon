...
**names** | [**Vec <crate::models::CloudJobFilesName>**](CloudJobFilesName.md) | A list of files to be addressed by this job.  (Note* these are only reported when audit_level is &#39;high&#39; | [optional] [default to null]
