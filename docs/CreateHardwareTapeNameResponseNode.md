...
**rescan_report** | [**Vec<::models::CreateHardwareTapeNameResponseNodeRescanReportItem>**](CreateHardwareTapeNameResponseNodeRescanReportItem.md) | A list of device rescan status | [optional] [default to null]
