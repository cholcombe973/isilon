...
**nodes** | [**Vec<::models::NodeDrivesPurposelistNode>**](NodeDrivesPurposelistNode.md) | The responses from the individual nodes involved in this request. | [optional] [default to null]
