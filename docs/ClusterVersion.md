...
**nodes** | [**Vec <crate::models::ClusterVersionNode>**](ClusterVersionNode.md) | The responses from the individual nodes involved in this request. | [optional] [default to null]
