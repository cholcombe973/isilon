...
**nodes** | [**Vec <crate::models::NodeStateServicelightNode>**](NodeStateServicelightNode.md) | The responses from the individual nodes involved in this request. | [optional] [default to null]
