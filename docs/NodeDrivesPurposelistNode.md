...
**purposes** | [**Vec<::models::NodeDrivesPurposelistNodePurpose>**](NodeDrivesPurposelistNodePurpose.md) | List of the drive purposes available on this node. | [optional] [default to null]
