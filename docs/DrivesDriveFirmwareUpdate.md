...
**nodes** | [**Vec <crate::models::DrivesDriveFirmwareUpdateNode>**](DrivesDriveFirmwareUpdateNode.md) | The responses from the individual nodes involved in this request. | [optional] [default to null]
