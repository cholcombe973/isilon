...
pub trait FsaApi {
    ...
    fn get_fsa_result(&self, fsa_result_id: &str) -> Box<Future<Item = ::models::FsaResults, Error = Error>>;
    fn get_fsa_results(&self, ) -> Box<Future<Item = ::models::FsaResultsExtended, Error = Error>>;
    fn get_fsa_settings(&self, scope: &str) -> Box<Future<Item = ::models::FsaSettings, Error = Error>>;
    fn update_fsa_result(&self, fsa_result: ::models::FsaResult, fsa_result_id: &str) -> Box<Future<Item = (), Error = Error>>;
    fn update_fsa_settings(&self, fsa_settings: ::models::FsaSettingsSettings) -> Box<Future<Item = (), Error = Error>>;
}
...
impl<C: hyper::client::Connect>FsaApi for FsaApiClient<C> {
    fn delete_fsa_result(&self, fsa_result_id: &str) -> Box<Future<Item = (), Error = Error>> {
        ...
        let uri_str = format!("{}/platform/3/fsa/results/{FsaResultId}", configuration.base_path, FsaResultId=fsa_result_id);
    ...
    fn get_fsa_results(&self, ) -> Box<Future<Item = ::models::FsaResultsExtended, Error = Error>> {
        ...
        Box::new(
            ...
            .map_err(|e| Error::from(e))
            .and_then(|body| {
                let parsed: Result<::models::FsaResultsExtended, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            }).map_err(|e| Error::from(e))
        )
    }
    ...
    fn get_fsa_settings(&self, scope: &str) -> Box<Future<Item = ::models::FsaSettings, Error = Error>> {
        ...
        let query = ::url::form_urlencoded::Serializer::new(String::new())
            ...
            .finish();
        let uri_str = format!("{}/platform/1/fsa/settings{}", configuration.base_path, query);
