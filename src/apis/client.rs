...
impl<C: hyper::client::Connect> APIClient<C> {
  pub fn new(configuration: Configuration<C>) -> APIClient<C> {
    ...
    APIClient {
      ...
      network_groupnets_subnets_api: Box::new(::apis::NetworkGroupnetsSubnetsApiClient::new(rc.clone())),
      ...
      snapshot_changelists_api: Box::new(::apis::SnapshotChangelistsApiClient::new(rc.clone())),
