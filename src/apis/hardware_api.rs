...
pub trait HardwareApi {
    fn create_hardware_tape_name(
        &self,
        hardware_tape_name: ::models::Empty,
        hardware_tape_name2: &str,
        lnn: &str,
        port: i32,
        timeout: f32,
        reconcile: bool,
    ) -> Box<Future<Item = ::models::CreateHardwareTapeNameResponse, Error = Error>>;
    ...
    fn get_hardware_fcport(
        ...
        lnn: &str,
    ) -> Box<Future<Item = ::models::HardwareFcports, Error = Error>>;
    ...
    fn get_hardware_tapes(
        ...
        activepath: &str,
        _type: &str,
    ) -> Box<Future<Item = ::models::HardwareTapes, Error = Error>>;
    fn update_hardware_fcport(
        &self,
        hardware_fcport: ::models::HardwareFcport,
        hardware_fcport_id: i32,
        lnn: &str,
    ) -> Box<Future<Item = (), Error = Error>>;
    fn update_hardware_tape_name(
        &self,
        hardware_tape_name_params: ::models::HardwareTapeNameParams,
        hardware_tape_name: &str,
    ) -> Box<Future<Item = (), Error = Error>>;
}
    ...
    fn create_hardware_tape_name(
        ...
        Box::new(
            configuration
                ...
                .and_then(|body| {
                    let parsed: Result<
                        ::models::CreateHardwareTapeNameResponse,
                        _,
    ...
    fn get_hardware_fcport(
        ...
        Box::new(
            configuration
                ...
                .map_err(|e| Error::from(e))
                .and_then(|body| {
                    let parsed: Result<::models::HardwareFcports, _> =
                        serde_json::from_slice(&body);
                    parsed.map_err(|e| Error::from(e))
                })
                .map_err(|e| Error::from(e)),
