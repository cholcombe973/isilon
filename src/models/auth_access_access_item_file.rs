...
pub struct AuthAccessAccessItemFile {
    ...
    pub file_permissions: Option<::models::AuthAccessAccessItemFileFilePermissions>,
    /// Specifies properties for a persona, which consists of either a 'type' and a 'name' or an 'ID'.
    #[serde(rename = "group")]
    pub group: Option<::models::AuthAccessAccessItemFileGroup>,
    /// Specifies whether path is inside snapshot.
    #[serde(rename = "is_snapshot")]
    pub is_snapshot: Option<bool>,
    /// Specifies properties for a persona, which consists of either a 'type' and a 'name' or an 'ID'.
    #[serde(rename = "owner")]
    pub owner: Option<::models::AuthAccessAccessItemFileGroup>,
}
