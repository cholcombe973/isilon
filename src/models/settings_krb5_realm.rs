...
impl SettingsKrb5Realm {
  /// Specifies the Kerberos settings for realm access.
  pub fn new() -> SettingsKrb5Realm {
    SettingsKrb5Realm {
      admin_server: None,
      default_domain: None,
  ...
  pub fn with_admin_server(mut self, admin_server: String) -> SettingsKrb5Realm {
    self.admin_server = Some(admin_server);
    self
  }
  ...
  pub fn with_default_domain(mut self, default_domain: String) -> SettingsKrb5Realm {
    self.default_domain = Some(default_domain);
    self
  }
  ...
  pub fn with_is_default_realm(mut self, is_default_realm: bool) -> SettingsKrb5Realm {
    self.is_default_realm = Some(is_default_realm);
    self
  }
  ...
  pub fn with_kdc(mut self, kdc: Vec<String>) -> SettingsKrb5Realm {
    self.kdc = Some(kdc);
    self
  }
