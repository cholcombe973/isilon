...
impl NetworkGroupnetCreateParams {
  pub fn new(name: String) -> NetworkGroupnetCreateParams {
  ...
  pub fn with_description(mut self, description: String) -> NetworkGroupnetCreateParams {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_dns_cache_enabled(mut self, dns_cache_enabled: bool) -> NetworkGroupnetCreateParams {
    self.dns_cache_enabled = Some(dns_cache_enabled);
    self
  }
  ...
  pub fn with_dns_options(mut self, dns_options: Vec<String>) -> NetworkGroupnetCreateParams {
    self.dns_options = Some(dns_options);
    self
  }
  ...
  pub fn with_dns_search(mut self, dns_search: Vec<String>) -> NetworkGroupnetCreateParams {
    self.dns_search = Some(dns_search);
    self
  }
  ...
  pub fn with_dns_servers(mut self, dns_servers: Vec<String>) -> NetworkGroupnetCreateParams {
    self.dns_servers = Some(dns_servers);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> NetworkGroupnetCreateParams {
    self.name = name;
    self
  }
  ...
  pub fn with_server_side_dns_search(mut self, server_side_dns_search: bool) -> NetworkGroupnetCreateParams {
    self.server_side_dns_search = Some(server_side_dns_search);
    self
  }
