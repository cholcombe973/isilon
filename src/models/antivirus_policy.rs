...
impl AntivirusPolicy {
  /// An antivirus scan policy.
  pub fn new() -> AntivirusPolicy {
    AntivirusPolicy {
      description: None,
      enabled: None,
      force_run: None,
  ...
  pub fn with_description(mut self, description: String) -> AntivirusPolicy {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> AntivirusPolicy {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_force_run(mut self, force_run: bool) -> AntivirusPolicy {
    self.force_run = Some(force_run);
    self
  }
  ...
  pub fn with_impact(mut self, impact: String) -> AntivirusPolicy {
    self.impact = Some(impact);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> AntivirusPolicy {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_paths(mut self, paths: Vec<String>) -> AntivirusPolicy {
    self.paths = Some(paths);
    self
  }
  ...
  pub fn with_recursion_depth(mut self, recursion_depth: i32) -> AntivirusPolicy {
    self.recursion_depth = Some(recursion_depth);
    self
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> AntivirusPolicy {
    self.schedule = Some(schedule);
    self
  }
