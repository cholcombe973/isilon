...
impl ProvidersFileFileItem {
  pub fn new() -> ProvidersFileFileItem {
  ...
  pub fn with_authentication(mut self, authentication: bool) -> ProvidersFileFileItem {
    self.authentication = Some(authentication);
    self
  }
  ...
  pub fn with_create_home_directory(mut self, create_home_directory: bool) -> ProvidersFileFileItem {
    self.create_home_directory = Some(create_home_directory);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> ProvidersFileFileItem {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_enumerate_groups(mut self, enumerate_groups: bool) -> ProvidersFileFileItem {
    self.enumerate_groups = Some(enumerate_groups);
    self
  }
  ...
  pub fn with_enumerate_users(mut self, enumerate_users: bool) -> ProvidersFileFileItem {
    self.enumerate_users = Some(enumerate_users);
    self
  }
  ...
  pub fn with_findable_groups(mut self, findable_groups: Vec<String>) -> ProvidersFileFileItem {
    self.findable_groups = Some(findable_groups);
    self
  }
  ...
  pub fn with_findable_users(mut self, findable_users: Vec<String>) -> ProvidersFileFileItem {
    self.findable_users = Some(findable_users);
    self
  }
  ...
  pub fn with_group_domain(mut self, group_domain: String) -> ProvidersFileFileItem {
    self.group_domain = Some(group_domain);
    self
  }
  ...
  pub fn set_group_file(&mut self, group_file: String) {
    self.group_file = Some(group_file);
  }

  pub fn with_group_file(mut self, group_file: String) -> ProvidersFileFileItem {
    self.group_file = Some(group_file);
    self
  }

  pub fn group_file(&self) -> Option<&String> {
    self.group_file.as_ref()
  }

  pub fn reset_group_file(&mut self) {
  ...
  pub fn with_home_directory_template(mut self, home_directory_template: String) -> ProvidersFileFileItem {
    self.home_directory_template = Some(home_directory_template);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> ProvidersFileFileItem {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_listable_groups(mut self, listable_groups: Vec<String>) -> ProvidersFileFileItem {
    self.listable_groups = Some(listable_groups);
    self
  }
  ...
  pub fn with_listable_users(mut self, listable_users: Vec<String>) -> ProvidersFileFileItem {
    self.listable_users = Some(listable_users);
    self
  }
  ...
  pub fn with_login_shell(mut self, login_shell: String) -> ProvidersFileFileItem {
    self.login_shell = Some(login_shell);
    self
  }
  ...
  pub fn with_modifiable_groups(mut self, modifiable_groups: Vec<String>) -> ProvidersFileFileItem {
    self.modifiable_groups = Some(modifiable_groups);
    self
  }
  ...
  pub fn with_modifiable_users(mut self, modifiable_users: Vec<String>) -> ProvidersFileFileItem {
    self.modifiable_users = Some(modifiable_users);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ProvidersFileFileItem {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_netgroup_file(mut self, netgroup_file: String) -> ProvidersFileFileItem {
    self.netgroup_file = Some(netgroup_file);
    self
  }
  ...
  pub fn with_normalize_groups(mut self, normalize_groups: bool) -> ProvidersFileFileItem {
    self.normalize_groups = Some(normalize_groups);
    self
  }
  ...
  pub fn with_normalize_users(mut self, normalize_users: bool) -> ProvidersFileFileItem {
    self.normalize_users = Some(normalize_users);
    self
  }
  ...
  pub fn with_ntlm_support(mut self, ntlm_support: String) -> ProvidersFileFileItem {
    self.ntlm_support = Some(ntlm_support);
    self
  }
  ...
  pub fn set_password_file(&mut self, password_file: String) {
    self.password_file = Some(password_file);
  }

  pub fn with_password_file(mut self, password_file: String) -> ProvidersFileFileItem {
    self.password_file = Some(password_file);
    self
  }
  ...
  pub fn reset_password_file(&mut self) {
  ...
  pub fn with_provider_domain(mut self, provider_domain: String) -> ProvidersFileFileItem {
    self.provider_domain = Some(provider_domain);
    self
  }
  ...
  pub fn with_restrict_findable(mut self, restrict_findable: bool) -> ProvidersFileFileItem {
    self.restrict_findable = Some(restrict_findable);
    self
  }
  ...
  pub fn with_restrict_listable(mut self, restrict_listable: bool) -> ProvidersFileFileItem {
    self.restrict_listable = Some(restrict_listable);
    self
  }
  ...
  pub fn with_restrict_modifiable(mut self, restrict_modifiable: bool) -> ProvidersFileFileItem {
    self.restrict_modifiable = Some(restrict_modifiable);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> ProvidersFileFileItem {
    self.status = Some(status);
    self
  }
  ...
  pub fn with_system(mut self, system: bool) -> ProvidersFileFileItem {
    self.system = Some(system);
    self
  }
  ...
  pub fn with_unfindable_groups(mut self, unfindable_groups: Vec<String>) -> ProvidersFileFileItem {
    self.unfindable_groups = Some(unfindable_groups);
    self
  }
  ...
  pub fn with_unfindable_users(mut self, unfindable_users: Vec<String>) -> ProvidersFileFileItem {
    self.unfindable_users = Some(unfindable_users);
    self
  }
  ...
  pub fn with_unlistable_groups(mut self, unlistable_groups: Vec<String>) -> ProvidersFileFileItem {
    self.unlistable_groups = Some(unlistable_groups);
    self
  }
  ...
  pub fn with_unlistable_users(mut self, unlistable_users: Vec<String>) -> ProvidersFileFileItem {
    self.unlistable_users = Some(unlistable_users);
    self
  }
  ...
  pub fn with_unmodifiable_groups(mut self, unmodifiable_groups: Vec<String>) -> ProvidersFileFileItem {
    self.unmodifiable_groups = Some(unmodifiable_groups);
    self
  }
  ...
  pub fn with_unmodifiable_users(mut self, unmodifiable_users: Vec<String>) -> ProvidersFileFileItem {
    self.unmodifiable_users = Some(unmodifiable_users);
    self
  }
  ...
  pub fn with_user_domain(mut self, user_domain: String) -> ProvidersFileFileItem {
    self.user_domain = Some(user_domain);
    self
  }
