...
impl WormDomainCreateParams {
  pub fn new(path: String) -> WormDomainCreateParams {
  ...
  pub fn with_autocommit_offset(mut self, autocommit_offset: i32) -> WormDomainCreateParams {
    self.autocommit_offset = Some(autocommit_offset);
    self
  }
  ...
  pub fn with_default_retention(mut self, default_retention: String) -> WormDomainCreateParams {
    self.default_retention = Some(default_retention);
    self
  }
  ...
  pub fn with_max_retention(mut self, max_retention: String) -> WormDomainCreateParams {
    self.max_retention = Some(max_retention);
    self
  }
  ...
  pub fn with_min_retention(mut self, min_retention: String) -> WormDomainCreateParams {
    self.min_retention = Some(min_retention);
    self
  }
  ...
  pub fn with_override_date(mut self, override_date: i32) -> WormDomainCreateParams {
    self.override_date = Some(override_date);
    self
  }
  ...
  pub fn with_privileged_delete(mut self, privileged_delete: String) -> WormDomainCreateParams {
    self.privileged_delete = Some(privileged_delete);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> WormDomainCreateParams {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> WormDomainCreateParams {
    self.path = path;
    self
  }
