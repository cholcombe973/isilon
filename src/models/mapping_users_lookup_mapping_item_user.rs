...
impl MappingUsersLookupMappingItemUser {
  pub fn new(enabled: bool, expired: bool, id: String, locked: bool, name: String, password_expired: bool, password_expires: bool, prompt_password_change: bool, _type: String, user_can_change_password: bool) -> MappingUsersLookupMappingItemUser {
  ...
  pub fn with_dn(mut self, dn: String) -> MappingUsersLookupMappingItemUser {
    self.dn = Some(dn);
    self
  }
  ...
  pub fn with_dns_domain(mut self, dns_domain: String) -> MappingUsersLookupMappingItemUser {
    self.dns_domain = Some(dns_domain);
    self
  }
  ...
  pub fn with_domain(mut self, domain: String) -> MappingUsersLookupMappingItemUser {
    self.domain = Some(domain);
    self
  }
  ...
  pub fn with_email(mut self, email: String) -> MappingUsersLookupMappingItemUser {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> MappingUsersLookupMappingItemUser {
    self.enabled = enabled;
    self
  }
  ...
  pub fn with_expired(mut self, expired: bool) -> MappingUsersLookupMappingItemUser {
    self.expired = expired;
    self
  }
  ...
  pub fn with_expiry(mut self, expiry: i32) -> MappingUsersLookupMappingItemUser {
    self.expiry = Some(expiry);
    self
  }
  ...
  pub fn with_gecos(mut self, gecos: String) -> MappingUsersLookupMappingItemUser {
    self.gecos = Some(gecos);
    self
  }
  ...
  pub fn with_generated_gid(mut self, generated_gid: bool) -> MappingUsersLookupMappingItemUser {
    self.generated_gid = Some(generated_gid);
    self
  }
  ...
  pub fn with_generated_uid(mut self, generated_uid: bool) -> MappingUsersLookupMappingItemUser {
    self.generated_uid = Some(generated_uid);
    self
  }
  ...
  pub fn with_generated_upn(mut self, generated_upn: bool) -> MappingUsersLookupMappingItemUser {
    self.generated_upn = Some(generated_upn);
    self
  }
  ...
  pub fn with_gid(mut self, gid: ::models::AuthAccessAccessItemFileGroup) -> MappingUsersLookupMappingItemUser {
    self.gid = Some(gid);
    self
  }
  ...
  pub fn with_home_directory(mut self, home_directory: String) -> MappingUsersLookupMappingItemUser {
    self.home_directory = Some(home_directory);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> MappingUsersLookupMappingItemUser {
    self.id = id;
    self
  }
  ...
  pub fn with_locked(mut self, locked: bool) -> MappingUsersLookupMappingItemUser {
    self.locked = locked;
    self
  }
  ...
  pub fn with_max_password_age(mut self, max_password_age: i32) -> MappingUsersLookupMappingItemUser {
    self.max_password_age = Some(max_password_age);
    self
  }
  ...
  pub fn with_member_of(mut self, member_of: Vec<::models::AuthAccessAccessItemFileGroup>) -> MappingUsersLookupMappingItemUser {
    self.member_of = Some(member_of);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> MappingUsersLookupMappingItemUser {
    self.name = name;
    self
  }
  ...
  pub fn with_object_history(mut self, object_history: Vec<::models::AuthGroupObjectHistoryItem>) -> MappingUsersLookupMappingItemUser {
    self.object_history = Some(object_history);
    self
  }
  ...
  pub fn with_on_disk_group_identity(mut self, on_disk_group_identity: ::models::AuthAccessAccessItemFileGroup) -> MappingUsersLookupMappingItemUser {
    self.on_disk_group_identity = Some(on_disk_group_identity);
    self
  }
  ...
  pub fn with_on_disk_user_identity(mut self, on_disk_user_identity: ::models::AuthAccessAccessItemFileGroup) -> MappingUsersLookupMappingItemUser {
    self.on_disk_user_identity = Some(on_disk_user_identity);
    self
  }
  ...
  pub fn with_password_expired(mut self, password_expired: bool) -> MappingUsersLookupMappingItemUser {
    self.password_expired = password_expired;
    self
  }
  ...
  pub fn with_password_expires(mut self, password_expires: bool) -> MappingUsersLookupMappingItemUser {
    self.password_expires = password_expires;
    self
  }

  pub fn password_expires(&self) -> &bool {
  ...
  pub fn with_password_expiry(mut self, password_expiry: i32) -> MappingUsersLookupMappingItemUser {
    self.password_expiry = Some(password_expiry);
    self
  }
  ...
  pub fn with_password_last_set(mut self, password_last_set: i32) -> MappingUsersLookupMappingItemUser {
    self.password_last_set = Some(password_last_set);
    self
  }
  ...
  pub fn with_primary_group_sid(mut self, primary_group_sid: ::models::AuthAccessAccessItemFileGroup) -> MappingUsersLookupMappingItemUser {
    self.primary_group_sid = Some(primary_group_sid);
    self
  }
  ...
  pub fn with_prompt_password_change(mut self, prompt_password_change: bool) -> MappingUsersLookupMappingItemUser {
    self.prompt_password_change = prompt_password_change;
    self
  }

  pub fn prompt_password_change(&self) -> &bool {
  ...
  pub fn with_provider(mut self, provider: String) -> MappingUsersLookupMappingItemUser {
    self.provider = Some(provider);
    self
  }
  ...
  pub fn with_sam_account_name(mut self, sam_account_name: String) -> MappingUsersLookupMappingItemUser {
    self.sam_account_name = Some(sam_account_name);
    self
  }
  ...
  pub fn with_shell(mut self, shell: String) -> MappingUsersLookupMappingItemUser {
    self.shell = Some(shell);
    self
  }
  ...
  pub fn with_sid(mut self, sid: ::models::AuthAccessAccessItemFileGroup) -> MappingUsersLookupMappingItemUser {
    self.sid = Some(sid);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> MappingUsersLookupMappingItemUser {
    self._type = _type;
    self
  }
  ...
  pub fn with_uid(mut self, uid: ::models::AuthAccessAccessItemFileGroup) -> MappingUsersLookupMappingItemUser {
    self.uid = Some(uid);
    self
  }
  ...
  pub fn with_upn(mut self, upn: String) -> MappingUsersLookupMappingItemUser {
    self.upn = Some(upn);
    self
  }
  ...
  pub fn with_user_can_change_password(mut self, user_can_change_password: bool) -> MappingUsersLookupMappingItemUser {
    self.user_can_change_password = user_can_change_password;
    self
  }

  pub fn user_can_change_password(&self) -> &bool {
