...
impl AuthAccessAccessItemFileGroup {
  pub fn new() -> AuthAccessAccessItemFileGroup {
  ...
  pub fn with_id(mut self, id: String) -> AuthAccessAccessItemFileGroup {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> AuthAccessAccessItemFileGroup {
    self.name = Some(name);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> AuthAccessAccessItemFileGroup {
    self._type = Some(_type);
    self
  }
