...
impl NodeSleds {
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> NodeSleds {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::NodeSledsNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::NodeSledsNode>) -> NodeSleds {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::NodeSledsNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> NodeSleds {
    self.total = Some(total);
    self
  }
