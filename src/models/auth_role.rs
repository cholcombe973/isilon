...
impl AuthRole {
  ...
  pub fn with_description(mut self, description: String) -> AuthRole {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_members(mut self, members: Vec<::models::AuthAccessAccessItemFileGroup>) -> AuthRole {
    self.members = Some(members);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> AuthRole {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_privileges(mut self, privileges: Vec<::models::AuthIdNtokenPrivilegeItem>) -> AuthRole {
    self.privileges = Some(privileges);
    self
  }
