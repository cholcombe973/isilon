...
impl NodeSensors {
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> NodeSensors {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::NodeSensorsNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::NodeSensorsNode>) -> NodeSensors {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::NodeSensorsNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> NodeSensors {
    self.total = Some(total);
    self
  }
