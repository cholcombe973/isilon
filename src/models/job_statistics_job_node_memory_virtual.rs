...
impl JobStatisticsJobNodeMemoryVirtual {
  pub fn new(current: f32, maximum: f32, minimum: f32) -> JobStatisticsJobNodeMemoryVirtual {
  ...
  pub fn with_average(mut self, average: f32) -> JobStatisticsJobNodeMemoryVirtual {
    self.average = Some(average);
    self
  }
  ...
  pub fn with_current(mut self, current: f32) -> JobStatisticsJobNodeMemoryVirtual {
    self.current = current;
    self
  }
  ...
  pub fn with_maximum(mut self, maximum: f32) -> JobStatisticsJobNodeMemoryVirtual {
    self.maximum = maximum;
    self
  }
  ...
  pub fn with_minimum(mut self, minimum: f32) -> JobStatisticsJobNodeMemoryVirtual {
    self.minimum = minimum;
    self
  }
