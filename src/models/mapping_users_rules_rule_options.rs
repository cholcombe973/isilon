...
impl MappingUsersRulesRuleOptions {
  pub fn new() -> MappingUsersRulesRuleOptions {
  ...
  pub fn with__break(mut self, _break: bool) -> MappingUsersRulesRuleOptions {
    self._break = Some(_break);
    self
  }
  ...
  pub fn set_default_user(&mut self, default_user: ::models::MappingUsersRulesRuleUser2) {
    self.default_user = Some(default_user);
  }

  pub fn with_default_user(mut self, default_user: ::models::MappingUsersRulesRuleUser2) -> MappingUsersRulesRuleOptions {
    self.default_user = Some(default_user);
    self
  }

  pub fn default_user(&self) -> Option<&::models::MappingUsersRulesRuleUser2> {
  ...
  pub fn with_group(mut self, group: bool) -> MappingUsersRulesRuleOptions {
    self.group = Some(group);
    self
  }
  ...
  pub fn with_groups(mut self, groups: bool) -> MappingUsersRulesRuleOptions {
    self.groups = Some(groups);
    self
  }
  ...
  pub fn with_user(mut self, user: bool) -> MappingUsersRulesRuleOptions {
    self.user = Some(user);
    self
  }
