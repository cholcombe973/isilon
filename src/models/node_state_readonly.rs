...
impl NodeStateReadonly {
  pub fn new() -> NodeStateReadonly {
    NodeStateReadonly {
      errors: None,
      nodes: None,
      total: None
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> NodeStateReadonly {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::NodeStateReadonlyNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::NodeStateReadonlyNode>) -> NodeStateReadonly {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::NodeStateReadonlyNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> NodeStateReadonly {
    self.total = Some(total);
    self
  }
