...
impl HdfsRack {
  ...
  pub fn with_client_ip_ranges(mut self, client_ip_ranges: Vec<String>) -> HdfsRack {
    self.client_ip_ranges = Some(client_ip_ranges);
    self
  }
  ...
  pub fn with_ip_pools(mut self, ip_pools: Vec<String>) -> HdfsRack {
    self.ip_pools = Some(ip_pools);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> HdfsRack {
    self.name = Some(name);
    self
  }
