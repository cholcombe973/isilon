...
impl SmbShare {
  ...
  pub fn with_access_based_enumeration(mut self, access_based_enumeration: bool) -> SmbShare {
    self.access_based_enumeration = Some(access_based_enumeration);
    self
  }
  ...
  pub fn with_access_based_enumeration_root_only(mut self, access_based_enumeration_root_only: bool) -> SmbShare {
    self.access_based_enumeration_root_only = Some(access_based_enumeration_root_only);
    self
  }
  ...
  pub fn with_allow_delete_readonly(mut self, allow_delete_readonly: bool) -> SmbShare {
    self.allow_delete_readonly = Some(allow_delete_readonly);
    self
  }
  ...
  pub fn with_allow_execute_always(mut self, allow_execute_always: bool) -> SmbShare {
    self.allow_execute_always = Some(allow_execute_always);
    self
  }
  ...
  pub fn with_allow_variable_expansion(mut self, allow_variable_expansion: bool) -> SmbShare {
    self.allow_variable_expansion = Some(allow_variable_expansion);
    self
  }
  ...
  pub fn with_auto_create_directory(mut self, auto_create_directory: bool) -> SmbShare {
    self.auto_create_directory = Some(auto_create_directory);
    self
  }
  ...
  pub fn with_browsable(mut self, browsable: bool) -> SmbShare {
    self.browsable = Some(browsable);
    self
  }
  ...
  pub fn with_ca_timeout(mut self, ca_timeout: i32) -> SmbShare {
    self.ca_timeout = Some(ca_timeout);
    self
  }
  ...
  pub fn with_ca_write_integrity(mut self, ca_write_integrity: String) -> SmbShare {
    self.ca_write_integrity = Some(ca_write_integrity);
    self
  }
  ...
  pub fn with_change_notify(mut self, change_notify: String) -> SmbShare {
    self.change_notify = Some(change_notify);
    self
  }
  ...
  pub fn with_create_permissions(mut self, create_permissions: String) -> SmbShare {
    self.create_permissions = Some(create_permissions);
    self
  }
  ...
  pub fn with_csc_policy(mut self, csc_policy: String) -> SmbShare {
    self.csc_policy = Some(csc_policy);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> SmbShare {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_directory_create_mask(mut self, directory_create_mask: i32) -> SmbShare {
    self.directory_create_mask = Some(directory_create_mask);
    self
  }
  ...
  pub fn with_directory_create_mode(mut self, directory_create_mode: i32) -> SmbShare {
    self.directory_create_mode = Some(directory_create_mode);
    self
  }
  ...
  pub fn with_file_create_mask(mut self, file_create_mask: i32) -> SmbShare {
    self.file_create_mask = Some(file_create_mask);
    self
  }
  ...
  pub fn with_file_create_mode(mut self, file_create_mode: i32) -> SmbShare {
    self.file_create_mode = Some(file_create_mode);
    self
  }
  ...
  pub fn with_file_filter_extensions(mut self, file_filter_extensions: Vec<String>) -> SmbShare {
    self.file_filter_extensions = Some(file_filter_extensions);
    self
  }
  ...
  pub fn with_file_filter_type(mut self, file_filter_type: String) -> SmbShare {
    self.file_filter_type = Some(file_filter_type);
    self
  }
  ...
  pub fn with_file_filtering_enabled(mut self, file_filtering_enabled: bool) -> SmbShare {
    self.file_filtering_enabled = Some(file_filtering_enabled);
    self
  }
  ...
  pub fn with_hide_dot_files(mut self, hide_dot_files: bool) -> SmbShare {
    self.hide_dot_files = Some(hide_dot_files);
    self
  }
  ...
  pub fn with_host_acl(mut self, host_acl: Vec<String>) -> SmbShare {
    self.host_acl = Some(host_acl);
    self
  }
  ...
  pub fn with_impersonate_guest(mut self, impersonate_guest: String) -> SmbShare {
    self.impersonate_guest = Some(impersonate_guest);
    self
  }
  ...
  pub fn with_impersonate_user(mut self, impersonate_user: String) -> SmbShare {
    self.impersonate_user = Some(impersonate_user);
    self
  }
  ...
  pub fn with_inheritable_path_acl(mut self, inheritable_path_acl: bool) -> SmbShare {
    self.inheritable_path_acl = Some(inheritable_path_acl);
    self
  }
  ...
  pub fn with_mangle_byte_start(mut self, mangle_byte_start: i32) -> SmbShare {
    self.mangle_byte_start = Some(mangle_byte_start);
    self
  }
  ...
  pub fn with_mangle_map(mut self, mangle_map: Vec<String>) -> SmbShare {
    self.mangle_map = Some(mangle_map);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SmbShare {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_ntfs_acl_support(mut self, ntfs_acl_support: bool) -> SmbShare {
    self.ntfs_acl_support = Some(ntfs_acl_support);
    self
  }
  ...
  pub fn with_oplocks(mut self, oplocks: bool) -> SmbShare {
    self.oplocks = Some(oplocks);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> SmbShare {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_permissions(mut self, permissions: Vec<::models::SmbSharePermission>) -> SmbShare {
    self.permissions = Some(permissions);
    self
  }
  ...
  pub fn with_run_as_root(mut self, run_as_root: Vec<::models::AuthAccessAccessItemFileGroup>) -> SmbShare {
    self.run_as_root = Some(run_as_root);
    self
  }
  ...
  pub fn with_strict_ca_lockout(mut self, strict_ca_lockout: bool) -> SmbShare {
    self.strict_ca_lockout = Some(strict_ca_lockout);
    self
  }
  ...
  pub fn with_strict_flush(mut self, strict_flush: bool) -> SmbShare {
    self.strict_flush = Some(strict_flush);
    self
  }
  ...
  pub fn with_strict_locking(mut self, strict_locking: bool) -> SmbShare {
    self.strict_locking = Some(strict_locking);
    self
  }
  ...
  pub fn with_zone(mut self, zone: String) -> SmbShare {
    self.zone = Some(zone);
    self
  }
