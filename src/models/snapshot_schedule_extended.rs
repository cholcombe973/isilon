...
impl SnapshotScheduleExtended {
  pub fn new() -> SnapshotScheduleExtended {
  ...
  pub fn with_alias(mut self, alias: String) -> SnapshotScheduleExtended {
    self.alias = Some(alias);
    self
  }
  ...
  pub fn with_duration(mut self, duration: i32) -> SnapshotScheduleExtended {
    self.duration = Some(duration);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> SnapshotScheduleExtended {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SnapshotScheduleExtended {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_next_run(mut self, next_run: i32) -> SnapshotScheduleExtended {
    self.next_run = Some(next_run);
    self
  }
  ...
  pub fn with_next_snapshot(mut self, next_snapshot: String) -> SnapshotScheduleExtended {
    self.next_snapshot = Some(next_snapshot);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> SnapshotScheduleExtended {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_pattern(mut self, pattern: String) -> SnapshotScheduleExtended {
    self.pattern = Some(pattern);
    self
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> SnapshotScheduleExtended {
    self.schedule = Some(schedule);
    self
  }
