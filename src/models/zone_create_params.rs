...
impl ZoneCreateParams {
  pub fn new(name: String) -> ZoneCreateParams {
    ZoneCreateParams {
  ...
  pub fn with_alternate_system_provider(mut self, alternate_system_provider: String) -> ZoneCreateParams {
    self.alternate_system_provider = Some(alternate_system_provider);
    self
  }
  ...
  pub fn with_auth_providers(mut self, auth_providers: Vec<String>) -> ZoneCreateParams {
    self.auth_providers = Some(auth_providers);
    self
  }
  ...
  pub fn with_cache_entry_expiry(mut self, cache_entry_expiry: i32) -> ZoneCreateParams {
    self.cache_entry_expiry = Some(cache_entry_expiry);
    self
  }
  ...
  pub fn with_create_path(mut self, create_path: bool) -> ZoneCreateParams {
    self.create_path = Some(create_path);
    self
  }
  ...
  pub fn with_force_overlap(mut self, force_overlap: bool) -> ZoneCreateParams {
    self.force_overlap = Some(force_overlap);
    self
  }
  ...
  pub fn with_home_directory_umask(mut self, home_directory_umask: i32) -> ZoneCreateParams {
    self.home_directory_umask = Some(home_directory_umask);
    self
  }
  ...
  pub fn with_ifs_restricted(mut self, ifs_restricted: Vec<::models::AuthAccessAccessItemFileGroup>) -> ZoneCreateParams {
    self.ifs_restricted = Some(ifs_restricted);
    self
  }
  ...
  pub fn with_map_untrusted(mut self, map_untrusted: String) -> ZoneCreateParams {
    self.map_untrusted = Some(map_untrusted);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ZoneCreateParams {
    self.name = name;
    self
  }
  ...
  pub fn with_negative_cache_entry_expiry(mut self, negative_cache_entry_expiry: i32) -> ZoneCreateParams {
    self.negative_cache_entry_expiry = Some(negative_cache_entry_expiry);
    self
  }
  ...
  pub fn with_netbios_name(mut self, netbios_name: String) -> ZoneCreateParams {
    self.netbios_name = Some(netbios_name);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> ZoneCreateParams {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_skeleton_directory(mut self, skeleton_directory: String) -> ZoneCreateParams {
    self.skeleton_directory = Some(skeleton_directory);
    self
  }
  ...
  pub fn with_system_provider(mut self, system_provider: String) -> ZoneCreateParams {
    self.system_provider = Some(system_provider);
    self
  }
  ...
  pub fn with_user_mapping_rules(mut self, user_mapping_rules: Vec<String>) -> ZoneCreateParams {
    self.user_mapping_rules = Some(user_mapping_rules);
    self
  }
  ...
  pub fn with_groupnet(mut self, groupnet: String) -> ZoneCreateParams {
    self.groupnet = Some(groupnet);
    self
  }
