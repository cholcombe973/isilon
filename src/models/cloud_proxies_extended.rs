...
impl CloudProxiesExtended {
  pub fn new() -> CloudProxiesExtended {
  ...
  pub fn with_proxies(mut self, proxies: Vec<::models::CloudProxyExtended>) -> CloudProxiesExtended {
    self.proxies = Some(proxies);
    self
  }
  ...
  pub fn with_resume(mut self, resume: String) -> CloudProxiesExtended {
    self.resume = Some(resume);
    self
  }
  ...
  pub fn with_total(mut self, total: i32) -> CloudProxiesExtended {
    self.total = Some(total);
    self
  }
