...
impl SyncPolicy {
  ...
  pub fn with_accelerated_failback(mut self, accelerated_failback: bool) -> SyncPolicy {
    self.accelerated_failback = Some(accelerated_failback);
    self
  }
  ...
  pub fn with_action(mut self, action: String) -> SyncPolicy {
    self.action = Some(action);
    self
  }
  ...
  pub fn with_burst_mode(mut self, burst_mode: bool) -> SyncPolicy {
    self.burst_mode = Some(burst_mode);
    self
  }
  ...
  pub fn with_changelist(mut self, changelist: bool) -> SyncPolicy {
    self.changelist = Some(changelist);
    self
  }
  ...
  pub fn with_check_integrity(mut self, check_integrity: bool) -> SyncPolicy {
    self.check_integrity = Some(check_integrity);
    self
  }
  ...
  pub fn with_cloud_deep_copy(mut self, cloud_deep_copy: String) -> SyncPolicy {
    self.cloud_deep_copy = Some(cloud_deep_copy);
    self
  }
  ...
  pub fn with_conflicted(mut self, conflicted: bool) -> SyncPolicy {
    self.conflicted = Some(conflicted);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> SyncPolicy {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_disable_file_split(mut self, disable_file_split: bool) -> SyncPolicy {
    self.disable_file_split = Some(disable_file_split);
    self
  }
  ...
  pub fn with_disable_fofb(mut self, disable_fofb: bool) -> SyncPolicy {
    self.disable_fofb = Some(disable_fofb);
    self
  }
  ...
  pub fn with_disable_stf(mut self, disable_stf: bool) -> SyncPolicy {
    self.disable_stf = Some(disable_stf);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> SyncPolicy {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_expected_dataloss(mut self, expected_dataloss: bool) -> SyncPolicy {
    self.expected_dataloss = Some(expected_dataloss);
    self
  }
  ...
  pub fn with_file_matching_pattern(mut self, file_matching_pattern: ::models::SyncJobPolicyFileMatchingPattern) -> SyncPolicy {
    self.file_matching_pattern = Some(file_matching_pattern);
    self
  }
  ...
  pub fn with_force_interface(mut self, force_interface: bool) -> SyncPolicy {
    self.force_interface = Some(force_interface);
    self
  }
  ...
  pub fn with_job_delay(mut self, job_delay: i32) -> SyncPolicy {
    self.job_delay = Some(job_delay);
    self
  }
  ...
  pub fn with_log_level(mut self, log_level: String) -> SyncPolicy {
    self.log_level = Some(log_level);
    self
  }
  ...
  pub fn with_log_removed_files(mut self, log_removed_files: bool) -> SyncPolicy {
    self.log_removed_files = Some(log_removed_files);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SyncPolicy {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_password(mut self, password: String) -> SyncPolicy {
    self.password = Some(password);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> SyncPolicy {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_report_max_age(mut self, report_max_age: i32) -> SyncPolicy {
    self.report_max_age = Some(report_max_age);
    self
  }
  ...
  pub fn with_report_max_count(mut self, report_max_count: i32) -> SyncPolicy {
    self.report_max_count = Some(report_max_count);
    self
  }
  ...
  pub fn with_restrict_target_network(mut self, restrict_target_network: bool) -> SyncPolicy {
    self.restrict_target_network = Some(restrict_target_network);
    self
  }
  ...
  pub fn with_rpo_alert(mut self, rpo_alert: i32) -> SyncPolicy {
    self.rpo_alert = Some(rpo_alert);
    self
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> SyncPolicy {
    self.schedule = Some(schedule);
    self
  }
  ...
  pub fn with_skip_lookup(mut self, skip_lookup: bool) -> SyncPolicy {
    self.skip_lookup = Some(skip_lookup);
    self
  }
  ...
  pub fn with_skip_when_source_unmodified(mut self, skip_when_source_unmodified: bool) -> SyncPolicy {
    self.skip_when_source_unmodified = Some(skip_when_source_unmodified);
    self
  }
  ...
  pub fn with_snapshot_sync_existing(mut self, snapshot_sync_existing: bool) -> SyncPolicy {
    self.snapshot_sync_existing = Some(snapshot_sync_existing);
    self
  }
  ...
  pub fn with_snapshot_sync_pattern(mut self, snapshot_sync_pattern: String) -> SyncPolicy {
    self.snapshot_sync_pattern = Some(snapshot_sync_pattern);
    self
  }
  ...
  pub fn with_source_exclude_directories(mut self, source_exclude_directories: Vec<String>) -> SyncPolicy {
    self.source_exclude_directories = Some(source_exclude_directories);
    self
  }
  ...
  pub fn with_source_include_directories(mut self, source_include_directories: Vec<String>) -> SyncPolicy {
    self.source_include_directories = Some(source_include_directories);
    self
  }
  ...
  pub fn with_source_network(mut self, source_network: ::models::SyncPolicySourceNetwork) -> SyncPolicy {
    self.source_network = Some(source_network);
    self
  }
  ...
  pub fn with_source_root_path(mut self, source_root_path: String) -> SyncPolicy {
    self.source_root_path = Some(source_root_path);
    self
  }
  ...
  pub fn with_source_snapshot_archive(mut self, source_snapshot_archive: bool) -> SyncPolicy {
    self.source_snapshot_archive = Some(source_snapshot_archive);
    self
  }
  ...
  pub fn with_source_snapshot_expiration(mut self, source_snapshot_expiration: i32) -> SyncPolicy {
    self.source_snapshot_expiration = Some(source_snapshot_expiration);
    self
  }
  ...
  pub fn with_source_snapshot_pattern(mut self, source_snapshot_pattern: String) -> SyncPolicy {
    self.source_snapshot_pattern = Some(source_snapshot_pattern);
    self
  }
  ...
  pub fn with_target_compare_initial_sync(mut self, target_compare_initial_sync: bool) -> SyncPolicy {
    self.target_compare_initial_sync = Some(target_compare_initial_sync);
    self
  }
  ...
  pub fn with_target_detect_modifications(mut self, target_detect_modifications: bool) -> SyncPolicy {
    self.target_detect_modifications = Some(target_detect_modifications);
    self
  }
  ...
  pub fn with_target_host(mut self, target_host: String) -> SyncPolicy {
    self.target_host = Some(target_host);
    self
  }
  ...
  pub fn with_target_path(mut self, target_path: String) -> SyncPolicy {
    self.target_path = Some(target_path);
    self
  }
  ...
  pub fn with_target_snapshot_alias(mut self, target_snapshot_alias: String) -> SyncPolicy {
    self.target_snapshot_alias = Some(target_snapshot_alias);
    self
  }
  ...
  pub fn with_target_snapshot_archive(mut self, target_snapshot_archive: bool) -> SyncPolicy {
    self.target_snapshot_archive = Some(target_snapshot_archive);
    self
  }
  ...
  pub fn with_target_snapshot_expiration(mut self, target_snapshot_expiration: i32) -> SyncPolicy {
    self.target_snapshot_expiration = Some(target_snapshot_expiration);
    self
  }
  ...
  pub fn with_target_snapshot_pattern(mut self, target_snapshot_pattern: String) -> SyncPolicy {
    self.target_snapshot_pattern = Some(target_snapshot_pattern);
    self
  }
  ...
  pub fn with_workers_per_node(mut self, workers_per_node: i32) -> SyncPolicy {
    self.workers_per_node = Some(workers_per_node);
    self
  }
