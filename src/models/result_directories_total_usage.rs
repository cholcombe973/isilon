...
impl ResultDirectoriesTotalUsage {
  pub fn new(ads_cnt: i32, dir_cnt: i32, file_cnt: i32, lin: i32, log_size_sum: i32, log_size_sum_overflow: i32, name: String, other_cnt: i32, parent: i32, phys_size_sum: i32) -> ResultDirectoriesTotalUsage {
  ...
  pub fn with_ads_cnt(mut self, ads_cnt: i32) -> ResultDirectoriesTotalUsage {
    self.ads_cnt = ads_cnt;
    self
  }
  ...
  pub fn with_dir_cnt(mut self, dir_cnt: i32) -> ResultDirectoriesTotalUsage {
    self.dir_cnt = dir_cnt;
    self
  }
  ...
  pub fn with_file_cnt(mut self, file_cnt: i32) -> ResultDirectoriesTotalUsage {
    self.file_cnt = file_cnt;
    self
  }
  ...
  pub fn with_lin(mut self, lin: i32) -> ResultDirectoriesTotalUsage {
    self.lin = lin;
    self
  }
  ...
  pub fn with_log_size_sum(mut self, log_size_sum: i32) -> ResultDirectoriesTotalUsage {
    self.log_size_sum = log_size_sum;
    self
  }
  ...
  pub fn with_log_size_sum_overflow(mut self, log_size_sum_overflow: i32) -> ResultDirectoriesTotalUsage {
    self.log_size_sum_overflow = log_size_sum_overflow;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ResultDirectoriesTotalUsage {
    self.name = name;
    self
  }
  ...
  pub fn with_other_cnt(mut self, other_cnt: i32) -> ResultDirectoriesTotalUsage {
    self.other_cnt = other_cnt;
    self
  }
  ...
  pub fn with_parent(mut self, parent: i32) -> ResultDirectoriesTotalUsage {
    self.parent = parent;
    self
  }
  ...
  pub fn with_phys_size_sum(mut self, phys_size_sum: i32) -> ResultDirectoriesTotalUsage {
    self.phys_size_sum = phys_size_sum;
    self
  }
