...
impl NtpServersExtended {
  pub fn new() -> NtpServersExtended {
    NtpServersExtended {
      servers: None,
      resume: None,
      total: None
  ...
  pub fn with_servers(mut self, servers: Vec<::models::NtpServerExtended>) -> NtpServersExtended {
    self.servers = Some(servers);
    self
  }
  ...
  pub fn with_resume(mut self, resume: String) -> NtpServersExtended {
    self.resume = Some(resume);
    self
  }
  ...
  pub fn with_total(mut self, total: i32) -> NtpServersExtended {
    self.total = Some(total);
    self
  }
