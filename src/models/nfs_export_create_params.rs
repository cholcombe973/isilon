...
impl NfsExportCreateParams {
  pub fn new(paths: Vec<String>) -> NfsExportCreateParams {
  ...
  pub fn with_all_dirs(mut self, all_dirs: bool) -> NfsExportCreateParams {
    self.all_dirs = Some(all_dirs);
    self
  }
  ...
  pub fn with_block_size(mut self, block_size: i32) -> NfsExportCreateParams {
    self.block_size = Some(block_size);
    self
  }
  ...
  pub fn with_can_set_time(mut self, can_set_time: bool) -> NfsExportCreateParams {
    self.can_set_time = Some(can_set_time);
    self
  }
  ...
  pub fn with_case_insensitive(mut self, case_insensitive: bool) -> NfsExportCreateParams {
    self.case_insensitive = Some(case_insensitive);
    self
  }
  ...
  pub fn with_case_preserving(mut self, case_preserving: bool) -> NfsExportCreateParams {
    self.case_preserving = Some(case_preserving);
    self
  }
  ...
  pub fn with_chown_restricted(mut self, chown_restricted: bool) -> NfsExportCreateParams {
    self.chown_restricted = Some(chown_restricted);
    self
  }
  ...
  pub fn with_clients(mut self, clients: Vec<String>) -> NfsExportCreateParams {
    self.clients = Some(clients);
    self
  }
  ...
  pub fn with_commit_asynchronous(mut self, commit_asynchronous: bool) -> NfsExportCreateParams {
    self.commit_asynchronous = Some(commit_asynchronous);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> NfsExportCreateParams {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_directory_transfer_size(mut self, directory_transfer_size: i32) -> NfsExportCreateParams {
    self.directory_transfer_size = Some(directory_transfer_size);
    self
  }
  ...
  pub fn with_encoding(mut self, encoding: String) -> NfsExportCreateParams {
    self.encoding = Some(encoding);
    self
  }
  ...
  pub fn with_link_max(mut self, link_max: i32) -> NfsExportCreateParams {
    self.link_max = Some(link_max);
    self
  }
  ...
  pub fn with_map_all(mut self, map_all: ::models::NfsSettingsExportSettingsMapAll) -> NfsExportCreateParams {
    self.map_all = Some(map_all);
    self
  }
  ...
  pub fn with_map_failure(mut self, map_failure: ::models::NfsSettingsExportSettingsMapAll) -> NfsExportCreateParams {
    self.map_failure = Some(map_failure);
    self
  }
  ...
  pub fn with_map_full(mut self, map_full: bool) -> NfsExportCreateParams {
    self.map_full = Some(map_full);
    self
  }
  ...
  pub fn with_map_lookup_uid(mut self, map_lookup_uid: bool) -> NfsExportCreateParams {
    self.map_lookup_uid = Some(map_lookup_uid);
    self
  }
  ...
  pub fn with_map_non_root(mut self, map_non_root: ::models::NfsSettingsExportSettingsMapAll) -> NfsExportCreateParams {
    self.map_non_root = Some(map_non_root);
    self
  }
  ...
  pub fn with_map_retry(mut self, map_retry: bool) -> NfsExportCreateParams {
    self.map_retry = Some(map_retry);
    self
  }
  ...
  pub fn with_map_root(mut self, map_root: ::models::NfsSettingsExportSettingsMapAll) -> NfsExportCreateParams {
    self.map_root = Some(map_root);
    self
  }
  ...
  pub fn with_max_file_size(mut self, max_file_size: i32) -> NfsExportCreateParams {
    self.max_file_size = Some(max_file_size);
    self
  }
  ...
  pub fn with_name_max_size(mut self, name_max_size: i32) -> NfsExportCreateParams {
    self.name_max_size = Some(name_max_size);
    self
  }
  ...
  pub fn with_no_truncate(mut self, no_truncate: bool) -> NfsExportCreateParams {
    self.no_truncate = Some(no_truncate);
    self
  }
  ...
  pub fn with_paths(mut self, paths: Vec<String>) -> NfsExportCreateParams {
    self.paths = paths;
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> NfsExportCreateParams {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_read_only_clients(mut self, read_only_clients: Vec<String>) -> NfsExportCreateParams {
    self.read_only_clients = Some(read_only_clients);
    self
  }
  ...
  pub fn with_read_transfer_max_size(mut self, read_transfer_max_size: i32) -> NfsExportCreateParams {
    self.read_transfer_max_size = Some(read_transfer_max_size);
    self
  }
  ...
  pub fn with_read_transfer_multiple(mut self, read_transfer_multiple: i32) -> NfsExportCreateParams {
    self.read_transfer_multiple = Some(read_transfer_multiple);
    self
  }
  ...
  pub fn with_read_transfer_size(mut self, read_transfer_size: i32) -> NfsExportCreateParams {
    self.read_transfer_size = Some(read_transfer_size);
    self
  }
  ...
  pub fn with_read_write_clients(mut self, read_write_clients: Vec<String>) -> NfsExportCreateParams {
    self.read_write_clients = Some(read_write_clients);
    self
  }
  ...
  pub fn with_readdirplus(mut self, readdirplus: bool) -> NfsExportCreateParams {
    self.readdirplus = Some(readdirplus);
    self
  }
  ...
  pub fn with_readdirplus_prefetch(mut self, readdirplus_prefetch: i32) -> NfsExportCreateParams {
    self.readdirplus_prefetch = Some(readdirplus_prefetch);
    self
  }
  ...
  pub fn with_return_32bit_file_ids(mut self, return_32bit_file_ids: bool) -> NfsExportCreateParams {
    self.return_32bit_file_ids = Some(return_32bit_file_ids);
    self
  }
  ...
  pub fn with_root_clients(mut self, root_clients: Vec<String>) -> NfsExportCreateParams {
    self.root_clients = Some(root_clients);
    self
  }
  ...
  pub fn with_security_flavors(mut self, security_flavors: Vec<String>) -> NfsExportCreateParams {
    self.security_flavors = Some(security_flavors);
    self
  }
  ...
  pub fn with_setattr_asynchronous(mut self, setattr_asynchronous: bool) -> NfsExportCreateParams {
    self.setattr_asynchronous = Some(setattr_asynchronous);
    self
  }
  ...
  pub fn with_snapshot(mut self, snapshot: String) -> NfsExportCreateParams {
    self.snapshot = Some(snapshot);
    self
  }
  ...
  pub fn with_symlinks(mut self, symlinks: bool) -> NfsExportCreateParams {
    self.symlinks = Some(symlinks);
    self
  }
  ...
  pub fn with_time_delta(mut self, time_delta: f32) -> NfsExportCreateParams {
    self.time_delta = Some(time_delta);
    self
  }
  ...
  pub fn with_write_datasync_action(mut self, write_datasync_action: String) -> NfsExportCreateParams {
    self.write_datasync_action = Some(write_datasync_action);
    self
  }
  ...
  pub fn with_write_datasync_reply(mut self, write_datasync_reply: String) -> NfsExportCreateParams {
    self.write_datasync_reply = Some(write_datasync_reply);
    self
  }
  ...
  pub fn with_write_filesync_action(mut self, write_filesync_action: String) -> NfsExportCreateParams {
    self.write_filesync_action = Some(write_filesync_action);
    self
  }
  ...
  pub fn with_write_filesync_reply(mut self, write_filesync_reply: String) -> NfsExportCreateParams {
    self.write_filesync_reply = Some(write_filesync_reply);
    self
  }
  ...
  pub fn with_write_transfer_max_size(mut self, write_transfer_max_size: i32) -> NfsExportCreateParams {
    self.write_transfer_max_size = Some(write_transfer_max_size);
    self
  }
  ...
  pub fn with_write_transfer_multiple(mut self, write_transfer_multiple: i32) -> NfsExportCreateParams {
    self.write_transfer_multiple = Some(write_transfer_multiple);
    self
  }
  ...
  pub fn with_write_transfer_size(mut self, write_transfer_size: i32) -> NfsExportCreateParams {
    self.write_transfer_size = Some(write_transfer_size);
    self
  }
  ...
  pub fn with_write_unstable_action(mut self, write_unstable_action: String) -> NfsExportCreateParams {
    self.write_unstable_action = Some(write_unstable_action);
    self
  }
  ...
  pub fn with_write_unstable_reply(mut self, write_unstable_reply: String) -> NfsExportCreateParams {
    self.write_unstable_reply = Some(write_unstable_reply);
    self
  }
  ...
  pub fn with_zone(mut self, zone: String) -> NfsExportCreateParams {
    self.zone = Some(zone);
    self
  }
