...
impl CloudAccountsExtended {
  pub fn new() -> CloudAccountsExtended {
  ...
  pub fn with_accounts(mut self, accounts: Vec<::models::CloudAccountExtended>) -> CloudAccountsExtended {
    self.accounts = Some(accounts);
    self
  }
  ...
  pub fn with_resume(mut self, resume: String) -> CloudAccountsExtended {
    self.resume = Some(resume);
    self
  }
  ...
  pub fn with_total(mut self, total: i32) -> CloudAccountsExtended {
    self.total = Some(total);
    self
  }
