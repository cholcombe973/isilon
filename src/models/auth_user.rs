...
impl AuthUser {
  ...
  pub fn with_email(mut self, email: String) -> AuthUser {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> AuthUser {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_expiry(mut self, expiry: i32) -> AuthUser {
    self.expiry = Some(expiry);
    self
  }
  ...
  pub fn with_gecos(mut self, gecos: String) -> AuthUser {
    self.gecos = Some(gecos);
    self
  }
  ...
  pub fn with_home_directory(mut self, home_directory: String) -> AuthUser {
    self.home_directory = Some(home_directory);
    self
  }
  ...
  pub fn with_password(mut self, password: String) -> AuthUser {
    self.password = Some(password);
    self
  }
  ...
  pub fn with_password_expires(mut self, password_expires: bool) -> AuthUser {
    self.password_expires = Some(password_expires);
    self
  }
  ...
  pub fn with_primary_group(mut self, primary_group: ::models::AuthAccessAccessItemFileGroup) -> AuthUser {
    self.primary_group = Some(primary_group);
    self
  }
  ...
  pub fn with_prompt_password_change(mut self, prompt_password_change: bool) -> AuthUser {
    self.prompt_password_change = Some(prompt_password_change);
    self
  }
  ...
  pub fn with_shell(mut self, shell: String) -> AuthUser {
    self.shell = Some(shell);
    self
  }
  ...
  pub fn with_sid(mut self, sid: String) -> AuthUser {
    self.sid = Some(sid);
    self
  }
  ...
  pub fn with_uid(mut self, uid: i32) -> AuthUser {
    self.uid = Some(uid);
    self
  }
  ...
  pub fn with_unlock(mut self, unlock: bool) -> AuthUser {
    self.unlock = Some(unlock);
    self
  }
