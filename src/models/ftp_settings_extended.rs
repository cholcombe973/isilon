...
impl FtpSettingsExtended {
  /// FTP settings.
  pub fn new() -> FtpSettingsExtended {
    FtpSettingsExtended {
      accept_timeout: None,
  ...
  pub fn with_accept_timeout(mut self, accept_timeout: i32) -> FtpSettingsExtended {
    self.accept_timeout = Some(accept_timeout);
    self
  }
  ...
  pub fn with_allow_anon_access(mut self, allow_anon_access: bool) -> FtpSettingsExtended {
    self.allow_anon_access = Some(allow_anon_access);
    self
  }
  ...
  pub fn with_allow_anon_upload(mut self, allow_anon_upload: bool) -> FtpSettingsExtended {
    self.allow_anon_upload = Some(allow_anon_upload);
    self
  }
  ...
  pub fn with_allow_dirlists(mut self, allow_dirlists: bool) -> FtpSettingsExtended {
    self.allow_dirlists = Some(allow_dirlists);
    self
  }
  ...
  pub fn with_allow_downloads(mut self, allow_downloads: bool) -> FtpSettingsExtended {
    self.allow_downloads = Some(allow_downloads);
    self
  }
  ...
  pub fn with_allow_local_access(mut self, allow_local_access: bool) -> FtpSettingsExtended {
    self.allow_local_access = Some(allow_local_access);
    self
  }
  ...
  pub fn with_allow_writes(mut self, allow_writes: bool) -> FtpSettingsExtended {
    self.allow_writes = Some(allow_writes);
    self
  }
  ...
  pub fn with_always_chdir_homedir(mut self, always_chdir_homedir: bool) -> FtpSettingsExtended {
    self.always_chdir_homedir = Some(always_chdir_homedir);
    self
  }
  ...
  pub fn with_anon_chown_username(mut self, anon_chown_username: String) -> FtpSettingsExtended {
    self.anon_chown_username = Some(anon_chown_username);
    self
  }
  ...
  pub fn with_anon_password_list(mut self, anon_password_list: Vec<String>) -> FtpSettingsExtended {
    self.anon_password_list = Some(anon_password_list);
    self
  }
  ...
  pub fn with_anon_root_path(mut self, anon_root_path: String) -> FtpSettingsExtended {
    self.anon_root_path = Some(anon_root_path);
    self
  }
  ...
  pub fn with_anon_umask(mut self, anon_umask: i32) -> FtpSettingsExtended {
    self.anon_umask = Some(anon_umask);
    self
  }
  ...
  pub fn with_ascii_mode(mut self, ascii_mode: String) -> FtpSettingsExtended {
    self.ascii_mode = Some(ascii_mode);
    self
  }
  ...
  pub fn with_chroot_exception_list(mut self, chroot_exception_list: Vec<String>) -> FtpSettingsExtended {
    self.chroot_exception_list = Some(chroot_exception_list);
    self
  }
  ...
  pub fn with_chroot_local_mode(mut self, chroot_local_mode: String) -> FtpSettingsExtended {
    self.chroot_local_mode = Some(chroot_local_mode);
    self
  }
  ...
  pub fn with_connect_timeout(mut self, connect_timeout: i32) -> FtpSettingsExtended {
    self.connect_timeout = Some(connect_timeout);
    self
  }
  ...
  pub fn with_data_timeout(mut self, data_timeout: i32) -> FtpSettingsExtended {
    self.data_timeout = Some(data_timeout);
    self
  }
  ...
  pub fn with_denied_user_list(mut self, denied_user_list: Vec<String>) -> FtpSettingsExtended {
    self.denied_user_list = Some(denied_user_list);
    self
  }
  ...
  pub fn with_dirlist_localtime(mut self, dirlist_localtime: bool) -> FtpSettingsExtended {
    self.dirlist_localtime = Some(dirlist_localtime);
    self
  }
  ...
  pub fn with_dirlist_names(mut self, dirlist_names: String) -> FtpSettingsExtended {
    self.dirlist_names = Some(dirlist_names);
    self
  }
  ...
  pub fn with_file_create_perm(mut self, file_create_perm: i32) -> FtpSettingsExtended {
    self.file_create_perm = Some(file_create_perm);
    self
  }
  ...
  pub fn with_limit_anon_passwords(mut self, limit_anon_passwords: bool) -> FtpSettingsExtended {
    self.limit_anon_passwords = Some(limit_anon_passwords);
    self
  }
  ...
  pub fn with_local_root_path(mut self, local_root_path: String) -> FtpSettingsExtended {
    self.local_root_path = Some(local_root_path);
    self
  }
  ...
  pub fn with_local_umask(mut self, local_umask: i32) -> FtpSettingsExtended {
    self.local_umask = Some(local_umask);
    self
  }
  ...
  pub fn with_server_to_server(mut self, server_to_server: bool) -> FtpSettingsExtended {
    self.server_to_server = Some(server_to_server);
    self
  }
  ...
  pub fn with_service(mut self, service: bool) -> FtpSettingsExtended {
    self.service = Some(service);
    self
  }
  ...
  pub fn with_session_support(mut self, session_support: bool) -> FtpSettingsExtended {
    self.session_support = Some(session_support);
    self
  }
  ...
  pub fn with_session_timeout(mut self, session_timeout: i32) -> FtpSettingsExtended {
    self.session_timeout = Some(session_timeout);
    self
  }
  ...
  pub fn with_user_config_dir(mut self, user_config_dir: String) -> FtpSettingsExtended {
    self.user_config_dir = Some(user_config_dir);
    self
  }
