...
impl ProvidersNisIdParams {
  ...
  pub fn with_authentication(mut self, authentication: bool) -> ProvidersNisIdParams {
    self.authentication = Some(authentication);
    self
  }
  ...
  pub fn with_balance_servers(mut self, balance_servers: bool) -> ProvidersNisIdParams {
    self.balance_servers = Some(balance_servers);
    self
  }
  ...
  pub fn with_check_online_interval(mut self, check_online_interval: i32) -> ProvidersNisIdParams {
    self.check_online_interval = Some(check_online_interval);
    self
  }
  ...
  pub fn with_create_home_directory(mut self, create_home_directory: bool) -> ProvidersNisIdParams {
    self.create_home_directory = Some(create_home_directory);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> ProvidersNisIdParams {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_enumerate_groups(mut self, enumerate_groups: bool) -> ProvidersNisIdParams {
    self.enumerate_groups = Some(enumerate_groups);
    self
  }
  ...
  pub fn with_enumerate_users(mut self, enumerate_users: bool) -> ProvidersNisIdParams {
    self.enumerate_users = Some(enumerate_users);
    self
  }
  ...
  pub fn with_findable_groups(mut self, findable_groups: Vec<String>) -> ProvidersNisIdParams {
    self.findable_groups = Some(findable_groups);
    self
  }
  ...
  pub fn with_findable_users(mut self, findable_users: Vec<String>) -> ProvidersNisIdParams {
    self.findable_users = Some(findable_users);
    self
  }
  ...
  pub fn with_group_domain(mut self, group_domain: String) -> ProvidersNisIdParams {
    self.group_domain = Some(group_domain);
    self
  }
  ...
  pub fn with_home_directory_template(mut self, home_directory_template: String) -> ProvidersNisIdParams {
    self.home_directory_template = Some(home_directory_template);
    self
  }
  ...
  pub fn with_hostname_lookup(mut self, hostname_lookup: bool) -> ProvidersNisIdParams {
    self.hostname_lookup = Some(hostname_lookup);
    self
  }
  ...
  pub fn with_listable_groups(mut self, listable_groups: Vec<String>) -> ProvidersNisIdParams {
    self.listable_groups = Some(listable_groups);
    self
  }
  ...
  pub fn with_listable_users(mut self, listable_users: Vec<String>) -> ProvidersNisIdParams {
    self.listable_users = Some(listable_users);
    self
  }
  ...
  pub fn with_login_shell(mut self, login_shell: String) -> ProvidersNisIdParams {
    self.login_shell = Some(login_shell);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ProvidersNisIdParams {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_nis_domain(mut self, nis_domain: String) -> ProvidersNisIdParams {
    self.nis_domain = Some(nis_domain);
    self
  }
  ...
  pub fn with_normalize_groups(mut self, normalize_groups: bool) -> ProvidersNisIdParams {
    self.normalize_groups = Some(normalize_groups);
    self
  }
  ...
  pub fn with_normalize_users(mut self, normalize_users: bool) -> ProvidersNisIdParams {
    self.normalize_users = Some(normalize_users);
    self
  }
  ...
  pub fn with_ntlm_support(mut self, ntlm_support: String) -> ProvidersNisIdParams {
    self.ntlm_support = Some(ntlm_support);
    self
  }
  ...
  pub fn with_provider_domain(mut self, provider_domain: String) -> ProvidersNisIdParams {
    self.provider_domain = Some(provider_domain);
    self
  }
  ...
  pub fn with_request_timeout(mut self, request_timeout: i32) -> ProvidersNisIdParams {
    self.request_timeout = Some(request_timeout);
    self
  }
  ...
  pub fn with_restrict_findable(mut self, restrict_findable: bool) -> ProvidersNisIdParams {
    self.restrict_findable = Some(restrict_findable);
    self
  }
  ...
  pub fn with_restrict_listable(mut self, restrict_listable: bool) -> ProvidersNisIdParams {
    self.restrict_listable = Some(restrict_listable);
    self
  }
  ...
  pub fn with_retry_time(mut self, retry_time: i32) -> ProvidersNisIdParams {
    self.retry_time = Some(retry_time);
    self
  }
  ...
  pub fn with_servers(mut self, servers: Vec<String>) -> ProvidersNisIdParams {
    self.servers = Some(servers);
    self
  }
  ...
  pub fn with_unfindable_groups(mut self, unfindable_groups: Vec<String>) -> ProvidersNisIdParams {
    self.unfindable_groups = Some(unfindable_groups);
    self
  }
  ...
  pub fn with_unfindable_users(mut self, unfindable_users: Vec<String>) -> ProvidersNisIdParams {
    self.unfindable_users = Some(unfindable_users);
    self
  }
  ...
  pub fn with_unlistable_groups(mut self, unlistable_groups: Vec<String>) -> ProvidersNisIdParams {
    self.unlistable_groups = Some(unlistable_groups);
    self
  }
  ...
  pub fn with_unlistable_users(mut self, unlistable_users: Vec<String>) -> ProvidersNisIdParams {
    self.unlistable_users = Some(unlistable_users);
    self
  }
  ...
  pub fn with_user_domain(mut self, user_domain: String) -> ProvidersNisIdParams {
    self.user_domain = Some(user_domain);
    self
  }
  ...
  pub fn with_ypmatch_using_tcp(mut self, ypmatch_using_tcp: bool) -> ProvidersNisIdParams {
    self.ypmatch_using_tcp = Some(ypmatch_using_tcp);
    self
  }
