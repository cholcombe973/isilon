...
impl SubnetsSubnetPoolsExtended {
  pub fn new() -> SubnetsSubnetPoolsExtended {
  ...
  pub fn with_pools(mut self, pools: Vec<::models::SubnetsSubnetPoolsPool>) -> SubnetsSubnetPoolsExtended {
    self.pools = Some(pools);
    self
  }
  ...
  pub fn with_resume(mut self, resume: String) -> SubnetsSubnetPoolsExtended {
    self.resume = Some(resume);
    self
  }
  ...
  pub fn with_total(mut self, total: i32) -> SubnetsSubnetPoolsExtended {
    self.total = Some(total);
    self
  }
