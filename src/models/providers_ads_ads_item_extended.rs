...
impl ProvidersAdsAdsItemExtended {
  pub fn new() -> ProvidersAdsAdsItemExtended {
  ...
  pub fn with_allocate_gids(mut self, allocate_gids: bool) -> ProvidersAdsAdsItemExtended {
    self.allocate_gids = Some(allocate_gids);
    self
  }
  ...
  pub fn with_allocate_uids(mut self, allocate_uids: bool) -> ProvidersAdsAdsItemExtended {
    self.allocate_uids = Some(allocate_uids);
    self
  }
  ...
  pub fn with_assume_default_domain(mut self, assume_default_domain: bool) -> ProvidersAdsAdsItemExtended {
    self.assume_default_domain = Some(assume_default_domain);
    self
  }
  ...
  pub fn with_authentication(mut self, authentication: bool) -> ProvidersAdsAdsItemExtended {
    self.authentication = Some(authentication);
    self
  }
  ...
  pub fn with_check_online_interval(mut self, check_online_interval: i32) -> ProvidersAdsAdsItemExtended {
    self.check_online_interval = Some(check_online_interval);
    self
  }
  ...
  pub fn with_controller_time(mut self, controller_time: i32) -> ProvidersAdsAdsItemExtended {
    self.controller_time = Some(controller_time);
    self
  }
  ...
  pub fn with_create_home_directory(mut self, create_home_directory: bool) -> ProvidersAdsAdsItemExtended {
    self.create_home_directory = Some(create_home_directory);
    self
  }
  ...
  pub fn with_domain_offline_alerts(mut self, domain_offline_alerts: bool) -> ProvidersAdsAdsItemExtended {
    self.domain_offline_alerts = Some(domain_offline_alerts);
    self
  }
  ...
  pub fn with_findable_groups(mut self, findable_groups: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.findable_groups = Some(findable_groups);
    self
  }
  ...
  pub fn with_findable_users(mut self, findable_users: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.findable_users = Some(findable_users);
    self
  }
  ...
  pub fn with_forest(mut self, forest: String) -> ProvidersAdsAdsItemExtended {
    self.forest = Some(forest);
    self
  }
  ...
  pub fn with_groupnet(mut self, groupnet: String) -> ProvidersAdsAdsItemExtended {
    self.groupnet = Some(groupnet);
    self
  }
  ...
  pub fn with_home_directory_template(mut self, home_directory_template: String) -> ProvidersAdsAdsItemExtended {
    self.home_directory_template = Some(home_directory_template);
    self
  }
  ...
  pub fn with_hostname(mut self, hostname: String) -> ProvidersAdsAdsItemExtended {
    self.hostname = Some(hostname);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> ProvidersAdsAdsItemExtended {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_ignore_all_trusts(mut self, ignore_all_trusts: bool) -> ProvidersAdsAdsItemExtended {
    self.ignore_all_trusts = Some(ignore_all_trusts);
    self
  }
  ...
  pub fn with_ignored_trusted_domains(mut self, ignored_trusted_domains: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.ignored_trusted_domains = Some(ignored_trusted_domains);
    self
  }
  ...
  pub fn with_include_trusted_domains(mut self, include_trusted_domains: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.include_trusted_domains = Some(include_trusted_domains);
    self
  }
  ...
  pub fn with_instance(mut self, instance: String) -> ProvidersAdsAdsItemExtended {
    self.instance = Some(instance);
    self
  }
  ...
  pub fn with_ldap_sign_and_seal(mut self, ldap_sign_and_seal: bool) -> ProvidersAdsAdsItemExtended {
    self.ldap_sign_and_seal = Some(ldap_sign_and_seal);
    self
  }
  ...
  pub fn with_login_shell(mut self, login_shell: String) -> ProvidersAdsAdsItemExtended {
    self.login_shell = Some(login_shell);
    self
  }
  ...
  pub fn with_lookup_domains(mut self, lookup_domains: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.lookup_domains = Some(lookup_domains);
    self
  }
  ...
  pub fn with_lookup_groups(mut self, lookup_groups: bool) -> ProvidersAdsAdsItemExtended {
    self.lookup_groups = Some(lookup_groups);
    self
  }
  ...
  pub fn with_lookup_normalize_groups(mut self, lookup_normalize_groups: bool) -> ProvidersAdsAdsItemExtended {
    self.lookup_normalize_groups = Some(lookup_normalize_groups);
    self
  }
  ...
  pub fn with_lookup_normalize_users(mut self, lookup_normalize_users: bool) -> ProvidersAdsAdsItemExtended {
    self.lookup_normalize_users = Some(lookup_normalize_users);
    self
  }
  ...
  pub fn with_lookup_users(mut self, lookup_users: bool) -> ProvidersAdsAdsItemExtended {
    self.lookup_users = Some(lookup_users);
    self
  }
  ...
  pub fn with_machine_account(mut self, machine_account: String) -> ProvidersAdsAdsItemExtended {
    self.machine_account = Some(machine_account);
    self
  }
  ...
  pub fn with_machine_name(mut self, machine_name: String) -> ProvidersAdsAdsItemExtended {
    self.machine_name = Some(machine_name);
    self
  }
  ...
  pub fn with_machine_password_changes(mut self, machine_password_changes: bool) -> ProvidersAdsAdsItemExtended {
    self.machine_password_changes = Some(machine_password_changes);
    self
  }
  ...
  pub fn with_machine_password_lifespan(mut self, machine_password_lifespan: i32) -> ProvidersAdsAdsItemExtended {
    self.machine_password_lifespan = Some(machine_password_lifespan);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ProvidersAdsAdsItemExtended {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_netbios_domain(mut self, netbios_domain: String) -> ProvidersAdsAdsItemExtended {
    self.netbios_domain = Some(netbios_domain);
    self
  }
  ...
  pub fn with_node_dc_affinity(mut self, node_dc_affinity: String) -> ProvidersAdsAdsItemExtended {
    self.node_dc_affinity = Some(node_dc_affinity);
    self
  }
  ...
  pub fn with_node_dc_affinity_timeout(mut self, node_dc_affinity_timeout: i32) -> ProvidersAdsAdsItemExtended {
    self.node_dc_affinity_timeout = Some(node_dc_affinity_timeout);
    self
  }
  ...
  pub fn with_nss_enumeration(mut self, nss_enumeration: bool) -> ProvidersAdsAdsItemExtended {
    self.nss_enumeration = Some(nss_enumeration);
    self
  }
  ...
  pub fn with_primary_domain(mut self, primary_domain: String) -> ProvidersAdsAdsItemExtended {
    self.primary_domain = Some(primary_domain);
    self
  }
  ...
  pub fn with_restrict_findable(mut self, restrict_findable: bool) -> ProvidersAdsAdsItemExtended {
    self.restrict_findable = Some(restrict_findable);
    self
  }
  ...
  pub fn with_sfu_support(mut self, sfu_support: String) -> ProvidersAdsAdsItemExtended {
    self.sfu_support = Some(sfu_support);
    self
  }
  ...
  pub fn with_site(mut self, site: String) -> ProvidersAdsAdsItemExtended {
    self.site = Some(site);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> ProvidersAdsAdsItemExtended {
    self.status = Some(status);
    self
  }
  ...
  pub fn with_store_sfu_mappings(mut self, store_sfu_mappings: bool) -> ProvidersAdsAdsItemExtended {
    self.store_sfu_mappings = Some(store_sfu_mappings);
    self
  }
  ...
  pub fn with_system(mut self, system: bool) -> ProvidersAdsAdsItemExtended {
    self.system = Some(system);
    self
  }
  ...
  pub fn with_unfindable_groups(mut self, unfindable_groups: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.unfindable_groups = Some(unfindable_groups);
    self
  }
  ...
  pub fn with_unfindable_users(mut self, unfindable_users: Vec<String>) -> ProvidersAdsAdsItemExtended {
    self.unfindable_users = Some(unfindable_users);
    self
  }
