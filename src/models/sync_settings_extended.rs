...
impl SyncSettingsExtended {
  /// Global SyncIQ settings.
  pub fn new() -> SyncSettingsExtended {
  ...
  pub fn with_burst_memory_constraint(mut self, burst_memory_constraint: i32) -> SyncSettingsExtended {
    self.burst_memory_constraint = Some(burst_memory_constraint);
    self
  }
  ...
  pub fn with_burst_socket_buffer_size(mut self, burst_socket_buffer_size: i32) -> SyncSettingsExtended {
    self.burst_socket_buffer_size = Some(burst_socket_buffer_size);
    self
  }
  ...
  pub fn with_force_interface(mut self, force_interface: bool) -> SyncSettingsExtended {
    self.force_interface = Some(force_interface);
    self
  }
  ...
  pub fn with_report_email(mut self, report_email: Vec<String>) -> SyncSettingsExtended {
    self.report_email = Some(report_email);
    self
  }
  ...
  pub fn with_report_max_age(mut self, report_max_age: i32) -> SyncSettingsExtended {
    self.report_max_age = Some(report_max_age);
    self
  }
  ...
  pub fn with_report_max_count(mut self, report_max_count: i32) -> SyncSettingsExtended {
    self.report_max_count = Some(report_max_count);
    self
  }
  ...
  pub fn with_restrict_target_network(mut self, restrict_target_network: bool) -> SyncSettingsExtended {
    self.restrict_target_network = Some(restrict_target_network);
    self
  }
  ...
  pub fn with_rpo_alerts(mut self, rpo_alerts: bool) -> SyncSettingsExtended {
    self.rpo_alerts = Some(rpo_alerts);
    self
  }
  ...
  pub fn with_service(mut self, service: String) -> SyncSettingsExtended {
    self.service = Some(service);
    self
  }
  ...
  pub fn with_source_network(mut self, source_network: ::models::SyncPolicySourceNetwork) -> SyncSettingsExtended {
    self.source_network = Some(source_network);
    self
  }
  ...
  pub fn with_tw_chkpt_interval(mut self, tw_chkpt_interval: i32) -> SyncSettingsExtended {
    self.tw_chkpt_interval = Some(tw_chkpt_interval);
    self
  }
