...
impl SettingsAclsExtended {
  /// ACL policies settings.
  pub fn new() -> SettingsAclsExtended {
  ...
  pub fn with_access(mut self, access: String) -> SettingsAclsExtended {
    self.access = Some(access);
    self
  }
  ...
  pub fn with_calcmode(mut self, calcmode: String) -> SettingsAclsExtended {
    self.calcmode = Some(calcmode);
    self
  }
  ...
  pub fn with_calcmode_group(mut self, calcmode_group: String) -> SettingsAclsExtended {
    self.calcmode_group = Some(calcmode_group);
    self
  }
  ...
  pub fn with_calcmode_owner(mut self, calcmode_owner: String) -> SettingsAclsExtended {
    self.calcmode_owner = Some(calcmode_owner);
    self
  }
  ...
  pub fn with_chmod(mut self, chmod: String) -> SettingsAclsExtended {
    self.chmod = Some(chmod);
    self
  }
  ...
  pub fn with_chmod_007(mut self, chmod_007: String) -> SettingsAclsExtended {
    self.chmod_007 = Some(chmod_007);
    self
  }
  ...
  pub fn with_chmod_inheritable(mut self, chmod_inheritable: String) -> SettingsAclsExtended {
    self.chmod_inheritable = Some(chmod_inheritable);
    self
  }
  ...
  pub fn with_chown(mut self, chown: String) -> SettingsAclsExtended {
    self.chown = Some(chown);
    self
  }
  ...
  pub fn with_create_over_smb(mut self, create_over_smb: String) -> SettingsAclsExtended {
    self.create_over_smb = Some(create_over_smb);
    self
  }
  ...
  pub fn with_dos_attr(mut self, dos_attr: String) -> SettingsAclsExtended {
    self.dos_attr = Some(dos_attr);
    self
  }
  ...
  pub fn with_group_owner_inheritance(mut self, group_owner_inheritance: String) -> SettingsAclsExtended {
    self.group_owner_inheritance = Some(group_owner_inheritance);
    self
  }
  ...
  pub fn with_rwx(mut self, rwx: String) -> SettingsAclsExtended {
    self.rwx = Some(rwx);
    self
  }
  ...
  pub fn with_synthetic_denies(mut self, synthetic_denies: String) -> SettingsAclsExtended {
    self.synthetic_denies = Some(synthetic_denies);
    self
  }
  ...
  pub fn with_utimes(mut self, utimes: String) -> SettingsAclsExtended {
    self.utimes = Some(utimes);
    self
  }
