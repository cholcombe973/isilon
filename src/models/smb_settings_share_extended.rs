...
impl SmbSettingsShareExtended {
  pub fn new() -> SmbSettingsShareExtended {
  ...
  pub fn with_access_based_enumeration(mut self, access_based_enumeration: bool) -> SmbSettingsShareExtended {
    self.access_based_enumeration = Some(access_based_enumeration);
    self
  }
  ...
  pub fn with_access_based_enumeration_root_only(mut self, access_based_enumeration_root_only: bool) -> SmbSettingsShareExtended {
    self.access_based_enumeration_root_only = Some(access_based_enumeration_root_only);
    self
  }
  ...
  pub fn with_allow_delete_readonly(mut self, allow_delete_readonly: bool) -> SmbSettingsShareExtended {
    self.allow_delete_readonly = Some(allow_delete_readonly);
    self
  }
  ...
  pub fn with_allow_execute_always(mut self, allow_execute_always: bool) -> SmbSettingsShareExtended {
    self.allow_execute_always = Some(allow_execute_always);
    self
  }
  ...
  pub fn with_ca_timeout(mut self, ca_timeout: i32) -> SmbSettingsShareExtended {
    self.ca_timeout = Some(ca_timeout);
    self
  }
  ...
  pub fn with_ca_write_integrity(mut self, ca_write_integrity: String) -> SmbSettingsShareExtended {
    self.ca_write_integrity = Some(ca_write_integrity);
    self
  }
  ...
  pub fn with_change_notify(mut self, change_notify: String) -> SmbSettingsShareExtended {
    self.change_notify = Some(change_notify);
    self
  }
  ...
  pub fn with_create_permissions(mut self, create_permissions: String) -> SmbSettingsShareExtended {
    self.create_permissions = Some(create_permissions);
    self
  }
  ...
  pub fn with_csc_policy(mut self, csc_policy: String) -> SmbSettingsShareExtended {
    self.csc_policy = Some(csc_policy);
    self
  }
  ...
  pub fn with_directory_create_mask(mut self, directory_create_mask: i32) -> SmbSettingsShareExtended {
    self.directory_create_mask = Some(directory_create_mask);
    self
  }
  ...
  pub fn with_directory_create_mode(mut self, directory_create_mode: i32) -> SmbSettingsShareExtended {
    self.directory_create_mode = Some(directory_create_mode);
    self
  }
  ...
  pub fn with_file_create_mask(mut self, file_create_mask: i32) -> SmbSettingsShareExtended {
    self.file_create_mask = Some(file_create_mask);
    self
  }
  ...
  pub fn with_file_create_mode(mut self, file_create_mode: i32) -> SmbSettingsShareExtended {
    self.file_create_mode = Some(file_create_mode);
    self
  }
  ...
  pub fn with_file_filter_extensions(mut self, file_filter_extensions: Vec<String>) -> SmbSettingsShareExtended {
    self.file_filter_extensions = Some(file_filter_extensions);
    self
  }
  ...
  pub fn with_file_filter_type(mut self, file_filter_type: String) -> SmbSettingsShareExtended {
    self.file_filter_type = Some(file_filter_type);
    self
  }
  ...
  pub fn with_file_filtering_enabled(mut self, file_filtering_enabled: bool) -> SmbSettingsShareExtended {
    self.file_filtering_enabled = Some(file_filtering_enabled);
    self
  }
  ...
  pub fn with_hide_dot_files(mut self, hide_dot_files: bool) -> SmbSettingsShareExtended {
    self.hide_dot_files = Some(hide_dot_files);
    self
  }
  ...
  pub fn with_host_acl(mut self, host_acl: Vec<String>) -> SmbSettingsShareExtended {
    self.host_acl = Some(host_acl);
    self
  }
  ...
  pub fn with_impersonate_guest(mut self, impersonate_guest: String) -> SmbSettingsShareExtended {
    self.impersonate_guest = Some(impersonate_guest);
    self
  }
  ...
  pub fn with_impersonate_user(mut self, impersonate_user: String) -> SmbSettingsShareExtended {
    self.impersonate_user = Some(impersonate_user);
    self
  }
  ...
  pub fn with_mangle_byte_start(mut self, mangle_byte_start: i32) -> SmbSettingsShareExtended {
    self.mangle_byte_start = Some(mangle_byte_start);
    self
  }
  ...
  pub fn with_mangle_map(mut self, mangle_map: Vec<String>) -> SmbSettingsShareExtended {
    self.mangle_map = Some(mangle_map);
    self
  }
  ...
  pub fn with_ntfs_acl_support(mut self, ntfs_acl_support: bool) -> SmbSettingsShareExtended {
    self.ntfs_acl_support = Some(ntfs_acl_support);
    self
  }
  ...
  pub fn with_oplocks(mut self, oplocks: bool) -> SmbSettingsShareExtended {
    self.oplocks = Some(oplocks);
    self
  }
  ...
  pub fn with_strict_ca_lockout(mut self, strict_ca_lockout: bool) -> SmbSettingsShareExtended {
    self.strict_ca_lockout = Some(strict_ca_lockout);
    self
  }
  ...
  pub fn with_strict_flush(mut self, strict_flush: bool) -> SmbSettingsShareExtended {
    self.strict_flush = Some(strict_flush);
    self
  }
  ...
  pub fn with_strict_locking(mut self, strict_locking: bool) -> SmbSettingsShareExtended {
    self.strict_locking = Some(strict_locking);
    self
  }
  ...
  pub fn with_zone(mut self, zone: String) -> SmbSettingsShareExtended {
    self.zone = Some(zone);
    self
  }
