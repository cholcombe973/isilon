...
impl SmbSettingsGlobalSettings {
  pub fn new() -> SmbSettingsGlobalSettings {
  ...
  pub fn with_access_based_share_enum(mut self, access_based_share_enum: bool) -> SmbSettingsGlobalSettings {
    self.access_based_share_enum = Some(access_based_share_enum);
    self
  }
  ...
  pub fn with_audit_fileshare(mut self, audit_fileshare: String) -> SmbSettingsGlobalSettings {
    self.audit_fileshare = Some(audit_fileshare);
    self
  }
  ...
  pub fn with_audit_global_sacl(mut self, audit_global_sacl: Vec<::models::SmbSettingsGlobalSettingsAuditGlobalSaclItem>) -> SmbSettingsGlobalSettings {
    self.audit_global_sacl = Some(audit_global_sacl);
    self
  }
  ...
  pub fn with_audit_logon(mut self, audit_logon: String) -> SmbSettingsGlobalSettings {
    self.audit_logon = Some(audit_logon);
    self
  }
  ...
  pub fn with_dot_snap_accessible_child(mut self, dot_snap_accessible_child: bool) -> SmbSettingsGlobalSettings {
    self.dot_snap_accessible_child = Some(dot_snap_accessible_child);
    self
  }
  ...
  pub fn with_dot_snap_accessible_root(mut self, dot_snap_accessible_root: bool) -> SmbSettingsGlobalSettings {
    self.dot_snap_accessible_root = Some(dot_snap_accessible_root);
    self
  }
  ...
  pub fn with_dot_snap_visible_child(mut self, dot_snap_visible_child: bool) -> SmbSettingsGlobalSettings {
    self.dot_snap_visible_child = Some(dot_snap_visible_child);
    self
  }
  ...
  pub fn with_dot_snap_visible_root(mut self, dot_snap_visible_root: bool) -> SmbSettingsGlobalSettings {
    self.dot_snap_visible_root = Some(dot_snap_visible_root);
    self
  }
  ...
  pub fn with_enable_security_signatures(mut self, enable_security_signatures: bool) -> SmbSettingsGlobalSettings {
    self.enable_security_signatures = Some(enable_security_signatures);
    self
  }
  ...
  pub fn with_guest_user(mut self, guest_user: String) -> SmbSettingsGlobalSettings {
    self.guest_user = Some(guest_user);
    self
  }
  ...
  pub fn with_ignore_eas(mut self, ignore_eas: bool) -> SmbSettingsGlobalSettings {
    self.ignore_eas = Some(ignore_eas);
    self
  }
  ...
  pub fn with_onefs_cpu_multiplier(mut self, onefs_cpu_multiplier: i32) -> SmbSettingsGlobalSettings {
    self.onefs_cpu_multiplier = Some(onefs_cpu_multiplier);
    self
  }
  ...
  pub fn with_onefs_num_workers(mut self, onefs_num_workers: i32) -> SmbSettingsGlobalSettings {
    self.onefs_num_workers = Some(onefs_num_workers);
    self
  }
  ...
  pub fn with_require_security_signatures(mut self, require_security_signatures: bool) -> SmbSettingsGlobalSettings {
    self.require_security_signatures = Some(require_security_signatures);
    self
  }
  ...
  pub fn with_server_side_copy(mut self, server_side_copy: bool) -> SmbSettingsGlobalSettings {
    self.server_side_copy = Some(server_side_copy);
    self
  }
  ...
  pub fn with_server_string(mut self, server_string: String) -> SmbSettingsGlobalSettings {
    self.server_string = Some(server_string);
    self
  }
  ...
  pub fn with_service(mut self, service: bool) -> SmbSettingsGlobalSettings {
    self.service = Some(service);
    self
  }
  ...
  pub fn with_srv_cpu_multiplier(mut self, srv_cpu_multiplier: i32) -> SmbSettingsGlobalSettings {
    self.srv_cpu_multiplier = Some(srv_cpu_multiplier);
    self
  }
  ...
  pub fn with_srv_num_workers(mut self, srv_num_workers: i32) -> SmbSettingsGlobalSettings {
    self.srv_num_workers = Some(srv_num_workers);
    self
  }
  ...
  pub fn with_support_multichannel(mut self, support_multichannel: bool) -> SmbSettingsGlobalSettings {
    self.support_multichannel = Some(support_multichannel);
    self
  }
  ...
  pub fn with_support_netbios(mut self, support_netbios: bool) -> SmbSettingsGlobalSettings {
    self.support_netbios = Some(support_netbios);
    self
  }
  ...
  pub fn with_support_smb2(mut self, support_smb2: bool) -> SmbSettingsGlobalSettings {
    self.support_smb2 = Some(support_smb2);
    self
  }
