...
impl SnapshotChangelists {
  pub fn new(id: String, job_id: i32, root_path: String, snap1: i32, snap2: i32, status: String) -> SnapshotChangelists {
    SnapshotChangelists {
      id: id,
      job_id: job_id,
      num_entries: None,
  ...
  pub fn with_id(mut self, id: String) -> SnapshotChangelists {
    self.id = id;
    self
  }
  ...
  pub fn with_job_id(mut self, job_id: i32) -> SnapshotChangelists {
    self.job_id = job_id;
    self
  }
  ...
  pub fn with_num_entries(mut self, num_entries: i32) -> SnapshotChangelists {
    self.num_entries = Some(num_entries);
    self
  }
  ...
  pub fn with_root_path(mut self, root_path: String) -> SnapshotChangelists {
    self.root_path = root_path;
    self
  }
  ...
  pub fn with_snap1(mut self, snap1: i32) -> SnapshotChangelists {
    self.snap1 = snap1;
    self
  }
  ...
  pub fn with_snap2(mut self, snap2: i32) -> SnapshotChangelists {
    self.snap2 = snap2;
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> SnapshotChangelists {
    self.status = status;
    self
  }
