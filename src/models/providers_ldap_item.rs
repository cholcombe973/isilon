...
impl ProvidersLdapItem {
  /// Specifies the properties for the LDAP authentication provider.
  pub fn new(base_dn: String, name: String, server_uris: Vec<String>) -> ProvidersLdapItem {
    ProvidersLdapItem {
  ...
  pub fn with_alternate_security_identities_attribute(mut self, alternate_security_identities_attribute: String) -> ProvidersLdapItem {
    self.alternate_security_identities_attribute = Some(alternate_security_identities_attribute);
    self
  }
  ...
  pub fn with_authentication(mut self, authentication: bool) -> ProvidersLdapItem {
    self.authentication = Some(authentication);
    self
  }
  ...
  pub fn with_balance_servers(mut self, balance_servers: bool) -> ProvidersLdapItem {
    self.balance_servers = Some(balance_servers);
    self
  }
  ...
  pub fn with_base_dn(mut self, base_dn: String) -> ProvidersLdapItem {
    self.base_dn = base_dn;
    self
  }
  ...
  pub fn with_bind_dn(mut self, bind_dn: String) -> ProvidersLdapItem {
    self.bind_dn = Some(bind_dn);
    self
  }
  ...
  pub fn with_bind_mechanism(mut self, bind_mechanism: String) -> ProvidersLdapItem {
    self.bind_mechanism = Some(bind_mechanism);
    self
  }
  ...
  pub fn with_bind_password(mut self, bind_password: String) -> ProvidersLdapItem {
    self.bind_password = Some(bind_password);
    self
  }
  ...
  pub fn with_bind_timeout(mut self, bind_timeout: i32) -> ProvidersLdapItem {
    self.bind_timeout = Some(bind_timeout);
    self
  }
  ...
  pub fn with_certificate_authority_file(mut self, certificate_authority_file: String) -> ProvidersLdapItem {
    self.certificate_authority_file = Some(certificate_authority_file);
    self
  }
  ...
  pub fn with_check_online_interval(mut self, check_online_interval: i32) -> ProvidersLdapItem {
    self.check_online_interval = Some(check_online_interval);
    self
  }
  ...
  pub fn with_cn_attribute(mut self, cn_attribute: String) -> ProvidersLdapItem {
    self.cn_attribute = Some(cn_attribute);
    self
  }
  ...
  pub fn with_create_home_directory(mut self, create_home_directory: bool) -> ProvidersLdapItem {
    self.create_home_directory = Some(create_home_directory);
    self
  }
  ...
  pub fn with_crypt_password_attribute(mut self, crypt_password_attribute: String) -> ProvidersLdapItem {
    self.crypt_password_attribute = Some(crypt_password_attribute);
    self
  }
  ...
  pub fn with_email_attribute(mut self, email_attribute: String) -> ProvidersLdapItem {
    self.email_attribute = Some(email_attribute);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> ProvidersLdapItem {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_enumerate_groups(mut self, enumerate_groups: bool) -> ProvidersLdapItem {
    self.enumerate_groups = Some(enumerate_groups);
    self
  }
  ...
  pub fn with_enumerate_users(mut self, enumerate_users: bool) -> ProvidersLdapItem {
    self.enumerate_users = Some(enumerate_users);
    self
  }
  ...
  pub fn with_findable_groups(mut self, findable_groups: Vec<String>) -> ProvidersLdapItem {
    self.findable_groups = Some(findable_groups);
    self
  }
  ...
  pub fn with_findable_users(mut self, findable_users: Vec<String>) -> ProvidersLdapItem {
    self.findable_users = Some(findable_users);
    self
  }
  ...
  pub fn with_gecos_attribute(mut self, gecos_attribute: String) -> ProvidersLdapItem {
    self.gecos_attribute = Some(gecos_attribute);
    self
  }
  ...
  pub fn with_gid_attribute(mut self, gid_attribute: String) -> ProvidersLdapItem {
    self.gid_attribute = Some(gid_attribute);
    self
  }
  ...
  pub fn with_group_base_dn(mut self, group_base_dn: String) -> ProvidersLdapItem {
    self.group_base_dn = Some(group_base_dn);
    self
  }
  ...
  pub fn with_group_domain(mut self, group_domain: String) -> ProvidersLdapItem {
    self.group_domain = Some(group_domain);
    self
  }
  ...
  pub fn with_group_filter(mut self, group_filter: String) -> ProvidersLdapItem {
    self.group_filter = Some(group_filter);
    self
  }
  ...
  pub fn with_group_members_attribute(mut self, group_members_attribute: String) -> ProvidersLdapItem {
    self.group_members_attribute = Some(group_members_attribute);
    self
  }
  ...
  pub fn with_group_search_scope(mut self, group_search_scope: String) -> ProvidersLdapItem {
    self.group_search_scope = Some(group_search_scope);
    self
  }
  ...
  pub fn with_groupnet(mut self, groupnet: String) -> ProvidersLdapItem {
    self.groupnet = Some(groupnet);
    self
  }
  ...
  pub fn with_home_directory_template(mut self, home_directory_template: String) -> ProvidersLdapItem {
    self.home_directory_template = Some(home_directory_template);
    self
  }
  ...
  pub fn with_homedir_attribute(mut self, homedir_attribute: String) -> ProvidersLdapItem {
    self.homedir_attribute = Some(homedir_attribute);
    self
  }
  ...
  pub fn with_ignore_tls_errors(mut self, ignore_tls_errors: bool) -> ProvidersLdapItem {
    self.ignore_tls_errors = Some(ignore_tls_errors);
    self
  }
  ...
  pub fn with_listable_groups(mut self, listable_groups: Vec<String>) -> ProvidersLdapItem {
    self.listable_groups = Some(listable_groups);
    self
  }
  ...
  pub fn with_listable_users(mut self, listable_users: Vec<String>) -> ProvidersLdapItem {
    self.listable_users = Some(listable_users);
    self
  }
  ...
  pub fn with_login_shell(mut self, login_shell: String) -> ProvidersLdapItem {
    self.login_shell = Some(login_shell);
    self
  }
  ...
  pub fn with_member_of_attribute(mut self, member_of_attribute: String) -> ProvidersLdapItem {
    self.member_of_attribute = Some(member_of_attribute);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ProvidersLdapItem {
    self.name = name;
    self
  }
  ...
  pub fn with_name_attribute(mut self, name_attribute: String) -> ProvidersLdapItem {
    self.name_attribute = Some(name_attribute);
    self
  }
  ...
  pub fn with_netgroup_base_dn(mut self, netgroup_base_dn: String) -> ProvidersLdapItem {
    self.netgroup_base_dn = Some(netgroup_base_dn);
    self
  }
  ...
  pub fn with_netgroup_filter(mut self, netgroup_filter: String) -> ProvidersLdapItem {
    self.netgroup_filter = Some(netgroup_filter);
    self
  }
  ...
  pub fn with_netgroup_members_attribute(mut self, netgroup_members_attribute: String) -> ProvidersLdapItem {
    self.netgroup_members_attribute = Some(netgroup_members_attribute);
    self
  }
  ...
  pub fn with_netgroup_search_scope(mut self, netgroup_search_scope: String) -> ProvidersLdapItem {
    self.netgroup_search_scope = Some(netgroup_search_scope);
    self
  }
  ...
  pub fn with_netgroup_triple_attribute(mut self, netgroup_triple_attribute: String) -> ProvidersLdapItem {
    self.netgroup_triple_attribute = Some(netgroup_triple_attribute);
    self
  }
  ...
  pub fn with_normalize_groups(mut self, normalize_groups: bool) -> ProvidersLdapItem {
    self.normalize_groups = Some(normalize_groups);
    self
  }
  ...
  pub fn with_normalize_users(mut self, normalize_users: bool) -> ProvidersLdapItem {
    self.normalize_users = Some(normalize_users);
    self
  }
  ...
  pub fn with_nt_password_attribute(mut self, nt_password_attribute: String) -> ProvidersLdapItem {
    self.nt_password_attribute = Some(nt_password_attribute);
    self
  }
  ...
  pub fn with_ntlm_support(mut self, ntlm_support: String) -> ProvidersLdapItem {
    self.ntlm_support = Some(ntlm_support);
    self
  }
  ...
  pub fn with_provider_domain(mut self, provider_domain: String) -> ProvidersLdapItem {
    self.provider_domain = Some(provider_domain);
    self
  }
  ...
  pub fn with_require_secure_connection(mut self, require_secure_connection: bool) -> ProvidersLdapItem {
    self.require_secure_connection = Some(require_secure_connection);
    self
  }
  ...
  pub fn with_restrict_findable(mut self, restrict_findable: bool) -> ProvidersLdapItem {
    self.restrict_findable = Some(restrict_findable);
    self
  }
  ...
  pub fn with_restrict_listable(mut self, restrict_listable: bool) -> ProvidersLdapItem {
    self.restrict_listable = Some(restrict_listable);
    self
  }
  ...
  pub fn with_search_scope(mut self, search_scope: String) -> ProvidersLdapItem {
    self.search_scope = Some(search_scope);
    self
  }
  ...
  pub fn with_search_timeout(mut self, search_timeout: i32) -> ProvidersLdapItem {
    self.search_timeout = Some(search_timeout);
    self
  }
  ...
  pub fn with_server_uris(mut self, server_uris: Vec<String>) -> ProvidersLdapItem {
    self.server_uris = server_uris;
    self
  }
  ...
  pub fn with_shadow_expire_attribute(mut self, shadow_expire_attribute: String) -> ProvidersLdapItem {
    self.shadow_expire_attribute = Some(shadow_expire_attribute);
    self
  }
  ...
  pub fn with_shadow_flag_attribute(mut self, shadow_flag_attribute: String) -> ProvidersLdapItem {
    self.shadow_flag_attribute = Some(shadow_flag_attribute);
    self
  }
  ...
  pub fn with_shadow_inactive_attribute(mut self, shadow_inactive_attribute: String) -> ProvidersLdapItem {
    self.shadow_inactive_attribute = Some(shadow_inactive_attribute);
    self
  }
  ...
  pub fn with_shadow_last_change_attribute(mut self, shadow_last_change_attribute: String) -> ProvidersLdapItem {
    self.shadow_last_change_attribute = Some(shadow_last_change_attribute);
    self
  }
  ...
  pub fn with_shadow_max_attribute(mut self, shadow_max_attribute: String) -> ProvidersLdapItem {
    self.shadow_max_attribute = Some(shadow_max_attribute);
    self
  }
  ...
  pub fn with_shadow_min_attribute(mut self, shadow_min_attribute: String) -> ProvidersLdapItem {
    self.shadow_min_attribute = Some(shadow_min_attribute);
    self
  }
  ...
  pub fn with_shadow_user_filter(mut self, shadow_user_filter: String) -> ProvidersLdapItem {
    self.shadow_user_filter = Some(shadow_user_filter);
    self
  }
  ...
  pub fn with_shadow_warning_attribute(mut self, shadow_warning_attribute: String) -> ProvidersLdapItem {
    self.shadow_warning_attribute = Some(shadow_warning_attribute);
    self
  }
  ...
  pub fn with_shell_attribute(mut self, shell_attribute: String) -> ProvidersLdapItem {
    self.shell_attribute = Some(shell_attribute);
    self
  }
  ...
  pub fn with_template(mut self, template: String) -> ProvidersLdapItem {
    self.template = Some(template);
    self
  }
  ...
  pub fn with_uid_attribute(mut self, uid_attribute: String) -> ProvidersLdapItem {
    self.uid_attribute = Some(uid_attribute);
    self
  }
  ...
  pub fn with_unfindable_groups(mut self, unfindable_groups: Vec<String>) -> ProvidersLdapItem {
    self.unfindable_groups = Some(unfindable_groups);
    self
  }
  ...
  pub fn with_unfindable_users(mut self, unfindable_users: Vec<String>) -> ProvidersLdapItem {
    self.unfindable_users = Some(unfindable_users);
    self
  }
  ...
  pub fn with_unique_group_members_attribute(mut self, unique_group_members_attribute: String) -> ProvidersLdapItem {
    self.unique_group_members_attribute = Some(unique_group_members_attribute);
    self
  }
  ...
  pub fn with_unlistable_groups(mut self, unlistable_groups: Vec<String>) -> ProvidersLdapItem {
    self.unlistable_groups = Some(unlistable_groups);
    self
  }
  ...
  pub fn with_unlistable_users(mut self, unlistable_users: Vec<String>) -> ProvidersLdapItem {
    self.unlistable_users = Some(unlistable_users);
    self
  }
  ...
  pub fn with_user_base_dn(mut self, user_base_dn: String) -> ProvidersLdapItem {
    self.user_base_dn = Some(user_base_dn);
    self
  }
  ...
  pub fn with_user_domain(mut self, user_domain: String) -> ProvidersLdapItem {
    self.user_domain = Some(user_domain);
    self
  }
  ...
  pub fn with_user_filter(mut self, user_filter: String) -> ProvidersLdapItem {
    self.user_filter = Some(user_filter);
    self
  }
  ...
  pub fn with_user_search_scope(mut self, user_search_scope: String) -> ProvidersLdapItem {
    self.user_search_scope = Some(user_search_scope);
    self
  }
