...
impl QuotaNotification {
  pub fn new() -> QuotaNotification {
    QuotaNotification {
      action_alert: None,
  ...
  pub fn with_action_alert(mut self, action_alert: bool) -> QuotaNotification {
    self.action_alert = Some(action_alert);
    self
  }
  ...
  pub fn with_action_email_address(mut self, action_email_address: String) -> QuotaNotification {
    self.action_email_address = Some(action_email_address);
    self
  }
  ...
  pub fn with_action_email_owner(mut self, action_email_owner: bool) -> QuotaNotification {
    self.action_email_owner = Some(action_email_owner);
    self
  }
  ...
  pub fn with_email_template(mut self, email_template: String) -> QuotaNotification {
    self.email_template = Some(email_template);
    self
  }
  ...
  pub fn with_holdoff(mut self, holdoff: i32) -> QuotaNotification {
    self.holdoff = Some(holdoff);
    self
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> QuotaNotification {
    self.schedule = Some(schedule);
    self
  }
