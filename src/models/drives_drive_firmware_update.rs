...
impl DrivesDriveFirmwareUpdate {
  pub fn new() -> DrivesDriveFirmwareUpdate {
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> DrivesDriveFirmwareUpdate {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::DrivesDriveFirmwareUpdateNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::DrivesDriveFirmwareUpdateNode>) -> DrivesDriveFirmwareUpdate {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::DrivesDriveFirmwareUpdateNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> DrivesDriveFirmwareUpdate {
    self.total = Some(total);
    self
  }
