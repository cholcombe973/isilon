...
impl HardwareFcports {
  pub fn new() -> HardwareFcports {
    HardwareFcports {
      errors: None,
      nodes: None,
      total: None
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> HardwareFcports {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::HardwareFcportsNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::HardwareFcportsNode>) -> HardwareFcports {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::HardwareFcportsNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> HardwareFcports {
    self.total = Some(total);
    self
  }
