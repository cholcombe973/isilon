...
impl SyncReport {
  ...
  pub fn with_action(mut self, action: String) -> SyncReport {
    self.action = action;
    self
  }
  ...
  pub fn with_ads_streams_replicated(mut self, ads_streams_replicated: i32) -> SyncReport {
    self.ads_streams_replicated = ads_streams_replicated;
    self
  }
  ...
  pub fn with_block_specs_replicated(mut self, block_specs_replicated: i32) -> SyncReport {
    self.block_specs_replicated = block_specs_replicated;
    self
  }
  ...
  pub fn with_bytes_recoverable(mut self, bytes_recoverable: i32) -> SyncReport {
    self.bytes_recoverable = bytes_recoverable;
    self
  }
  ...
  pub fn with_bytes_transferred(mut self, bytes_transferred: i32) -> SyncReport {
    self.bytes_transferred = bytes_transferred;
    self
  }
  ...
  pub fn with_char_specs_replicated(mut self, char_specs_replicated: i32) -> SyncReport {
    self.char_specs_replicated = char_specs_replicated;
    self
  }
  ...
  pub fn with_corrected_lins(mut self, corrected_lins: i32) -> SyncReport {
    self.corrected_lins = corrected_lins;
    self
  }
  ...
  pub fn with_dead_node(mut self, dead_node: bool) -> SyncReport {
    self.dead_node = dead_node;
    self
  }
  ...
  pub fn with_directories_replicated(mut self, directories_replicated: i32) -> SyncReport {
    self.directories_replicated = directories_replicated;
    self
  }
  ...
  pub fn with_dirs_changed(mut self, dirs_changed: i32) -> SyncReport {
    self.dirs_changed = dirs_changed;
    self
  }
  ...
  pub fn with_dirs_deleted(mut self, dirs_deleted: i32) -> SyncReport {
    self.dirs_deleted = dirs_deleted;
    self
  }
  ...
  pub fn with_dirs_moved(mut self, dirs_moved: i32) -> SyncReport {
    self.dirs_moved = dirs_moved;
    self
  }
  ...
  pub fn with_dirs_new(mut self, dirs_new: i32) -> SyncReport {
    self.dirs_new = dirs_new;
    self
  }
  ...
  pub fn with_duration(mut self, duration: i32) -> SyncReport {
    self.duration = Some(duration);
    self
  }
  ...
  pub fn with_end_time(mut self, end_time: i32) -> SyncReport {
    self.end_time = Some(end_time);
    self
  }
  ...
  pub fn with_error(mut self, error: String) -> SyncReport {
    self.error = error;
    self
  }
  ...
  pub fn with_error_checksum_files_skipped(mut self, error_checksum_files_skipped: i32) -> SyncReport {
    self.error_checksum_files_skipped = error_checksum_files_skipped;
    self
  }
  ...
  pub fn with_error_io_files_skipped(mut self, error_io_files_skipped: i32) -> SyncReport {
    self.error_io_files_skipped = error_io_files_skipped;
    self
  }
  ...
  pub fn with_error_net_files_skipped(mut self, error_net_files_skipped: i32) -> SyncReport {
    self.error_net_files_skipped = error_net_files_skipped;
    self
  }
  ...
  pub fn with_errors(mut self, errors: Vec<String>) -> SyncReport {
    self.errors = errors;
    self
  }
  ...
  pub fn with_failed_chunks(mut self, failed_chunks: i32) -> SyncReport {
    self.failed_chunks = failed_chunks;
    self
  }
  ...
  pub fn with_fifos_replicated(mut self, fifos_replicated: i32) -> SyncReport {
    self.fifos_replicated = fifos_replicated;
    self
  }
  ...
  pub fn with_file_data_bytes(mut self, file_data_bytes: i32) -> SyncReport {
    self.file_data_bytes = file_data_bytes;
    self
  }
  ...
  pub fn with_files_changed(mut self, files_changed: i32) -> SyncReport {
    self.files_changed = files_changed;
    self
  }
  ...
  pub fn with_files_linked(mut self, files_linked: i32) -> SyncReport {
    self.files_linked = files_linked;
    self
  }
  ...
  pub fn with_files_new(mut self, files_new: i32) -> SyncReport {
    self.files_new = files_new;
    self
  }
  ...
  pub fn with_files_selected(mut self, files_selected: i32) -> SyncReport {
    self.files_selected = files_selected;
    self
  }
  ...
  pub fn with_files_transferred(mut self, files_transferred: i32) -> SyncReport {
    self.files_transferred = files_transferred;
    self
  }
  ...
  pub fn with_files_unlinked(mut self, files_unlinked: i32) -> SyncReport {
    self.files_unlinked = files_unlinked;
    self
  }
  ...
  pub fn with_files_with_ads_replicated(mut self, files_with_ads_replicated: i32) -> SyncReport {
    self.files_with_ads_replicated = files_with_ads_replicated;
    self
  }
  ...
  pub fn with_flipped_lins(mut self, flipped_lins: i32) -> SyncReport {
    self.flipped_lins = flipped_lins;
    self
  }
  ...
  pub fn with_hard_links_replicated(mut self, hard_links_replicated: i32) -> SyncReport {
    self.hard_links_replicated = hard_links_replicated;
    self
  }
  ...
  pub fn with_hash_exceptions_fixed(mut self, hash_exceptions_fixed: i32) -> SyncReport {
    self.hash_exceptions_fixed = hash_exceptions_fixed;
    self
  }
  ...
  pub fn with_hash_exceptions_found(mut self, hash_exceptions_found: i32) -> SyncReport {
    self.hash_exceptions_found = hash_exceptions_found;
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> SyncReport {
    self.id = id;
    self
  }
  ...
  pub fn with_job_id(mut self, job_id: i32) -> SyncReport {
    self.job_id = Some(job_id);
    self
  }
  ...
  pub fn with_lins_total(mut self, lins_total: i32) -> SyncReport {
    self.lins_total = lins_total;
    self
  }
  ...
  pub fn with_network_bytes_to_source(mut self, network_bytes_to_source: i32) -> SyncReport {
    self.network_bytes_to_source = network_bytes_to_source;
    self
  }
  ...
  pub fn with_network_bytes_to_target(mut self, network_bytes_to_target: i32) -> SyncReport {
    self.network_bytes_to_target = network_bytes_to_target;
    self
  }
  ...
  pub fn with_new_files_replicated(mut self, new_files_replicated: i32) -> SyncReport {
    self.new_files_replicated = new_files_replicated;
    self
  }
  ...
  pub fn with_num_retransmitted_files(mut self, num_retransmitted_files: i32) -> SyncReport {
    self.num_retransmitted_files = num_retransmitted_files;
    self
  }
  ...
  pub fn with_phases(mut self, phases: Vec<::models::SyncJobPhase>) -> SyncReport {
    self.phases = phases;
    self
  }
  ...
  pub fn set_policy(&mut self, policy: ::models::SyncReportPolicy) {
    self.policy = policy;
  }

  pub fn with_policy(mut self, policy: ::models::SyncReportPolicy) -> SyncReport {
    self.policy = policy;
    self
  }

  pub fn policy(&self) -> &::models::SyncReportPolicy {
    &self.policy
  }
  ...
  pub fn with_policy_action(mut self, policy_action: String) -> SyncReport {
    self.policy_action = policy_action;
    self
  }
  ...
  pub fn with_policy_id(mut self, policy_id: String) -> SyncReport {
    self.policy_id = policy_id;
    self
  }
  ...
  pub fn with_policy_name(mut self, policy_name: String) -> SyncReport {
    self.policy_name = policy_name;
    self
  }
  ...
  pub fn with_regular_files_replicated(mut self, regular_files_replicated: i32) -> SyncReport {
    self.regular_files_replicated = regular_files_replicated;
    self
  }
  ...
  pub fn with_resynced_lins(mut self, resynced_lins: i32) -> SyncReport {
    self.resynced_lins = resynced_lins;
    self
  }
  ...
  pub fn with_retransmitted_files(mut self, retransmitted_files: Vec<String>) -> SyncReport {
    self.retransmitted_files = retransmitted_files;
    self
  }
  ...
  pub fn with_retry(mut self, retry: i32) -> SyncReport {
    self.retry = retry;
    self
  }
  ...
  pub fn with_running_chunks(mut self, running_chunks: i32) -> SyncReport {
    self.running_chunks = running_chunks;
    self
  }
  ...
  pub fn with_sockets_replicated(mut self, sockets_replicated: i32) -> SyncReport {
    self.sockets_replicated = sockets_replicated;
    self
  }
  ...
  pub fn with_source_bytes_recovered(mut self, source_bytes_recovered: i32) -> SyncReport {
    self.source_bytes_recovered = source_bytes_recovered;
    self
  }
  ...
  pub fn with_source_directories_created(mut self, source_directories_created: i32) -> SyncReport {
    self.source_directories_created = source_directories_created;
    self
  }
  ...
  pub fn with_source_directories_deleted(mut self, source_directories_deleted: i32) -> SyncReport {
    self.source_directories_deleted = source_directories_deleted;
    self
  }
  ...
  pub fn with_source_directories_linked(mut self, source_directories_linked: i32) -> SyncReport {
    self.source_directories_linked = source_directories_linked;
    self
  }
  ...
  pub fn with_source_directories_unlinked(mut self, source_directories_unlinked: i32) -> SyncReport {
    self.source_directories_unlinked = source_directories_unlinked;
    self
  }
  ...
  pub fn with_source_directories_visited(mut self, source_directories_visited: i32) -> SyncReport {
    self.source_directories_visited = source_directories_visited;
    self
  }
  ...
  pub fn with_source_files_deleted(mut self, source_files_deleted: i32) -> SyncReport {
    self.source_files_deleted = source_files_deleted;
    self
  }
  ...
  pub fn with_source_files_linked(mut self, source_files_linked: i32) -> SyncReport {
    self.source_files_linked = source_files_linked;
    self
  }
  ...
  pub fn with_source_files_unlinked(mut self, source_files_unlinked: i32) -> SyncReport {
    self.source_files_unlinked = source_files_unlinked;
    self
  }
  ...
  pub fn with_sparse_data_bytes(mut self, sparse_data_bytes: i32) -> SyncReport {
    self.sparse_data_bytes = sparse_data_bytes;
    self
  }
  ...
  pub fn with_start_time(mut self, start_time: i32) -> SyncReport {
    self.start_time = Some(start_time);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> SyncReport {
    self.state = state;
    self
  }
  ...
  pub fn with_subreport_count(mut self, subreport_count: i32) -> SyncReport {
    self.subreport_count = subreport_count;
    self
  }
  ...
  pub fn with_succeeded_chunks(mut self, succeeded_chunks: i32) -> SyncReport {
    self.succeeded_chunks = succeeded_chunks;
    self
  }
  ...
  pub fn with_symlinks_replicated(mut self, symlinks_replicated: i32) -> SyncReport {
    self.symlinks_replicated = symlinks_replicated;
    self
  }
  ...
  pub fn with_sync_type(mut self, sync_type: String) -> SyncReport {
    self.sync_type = sync_type;
    self
  }
  ...
  pub fn with_target_bytes_recovered(mut self, target_bytes_recovered: i32) -> SyncReport {
    self.target_bytes_recovered = target_bytes_recovered;
    self
  }
  ...
  pub fn with_target_directories_created(mut self, target_directories_created: i32) -> SyncReport {
    self.target_directories_created = target_directories_created;
    self
  }
  ...
  pub fn with_target_directories_deleted(mut self, target_directories_deleted: i32) -> SyncReport {
    self.target_directories_deleted = target_directories_deleted;
    self
  }
  ...
  pub fn with_target_directories_linked(mut self, target_directories_linked: i32) -> SyncReport {
    self.target_directories_linked = target_directories_linked;
    self
  }
  ...
  pub fn with_target_directories_unlinked(mut self, target_directories_unlinked: i32) -> SyncReport {
    self.target_directories_unlinked = target_directories_unlinked;
    self
  }
  ...
  pub fn with_target_files_deleted(mut self, target_files_deleted: i32) -> SyncReport {
    self.target_files_deleted = target_files_deleted;
    self
  }
  ...
  pub fn with_target_files_linked(mut self, target_files_linked: i32) -> SyncReport {
    self.target_files_linked = target_files_linked;
    self
  }
  ...
  pub fn with_target_files_unlinked(mut self, target_files_unlinked: i32) -> SyncReport {
    self.target_files_unlinked = target_files_unlinked;
    self
  }
  ...
  pub fn with_target_snapshots(mut self, target_snapshots: Vec<String>) -> SyncReport {
    self.target_snapshots = target_snapshots;
    self
  }
  ...
  pub fn with_total_chunks(mut self, total_chunks: i32) -> SyncReport {
    self.total_chunks = total_chunks;
    self
  }
  ...
  pub fn with_total_data_bytes(mut self, total_data_bytes: i32) -> SyncReport {
    self.total_data_bytes = total_data_bytes;
    self
  }
  ...
  pub fn with_total_files(mut self, total_files: i32) -> SyncReport {
    self.total_files = total_files;
    self
  }
  ...
  pub fn with_total_network_bytes(mut self, total_network_bytes: i32) -> SyncReport {
    self.total_network_bytes = total_network_bytes;
    self
  }
  ...
  pub fn with_total_phases(mut self, total_phases: i32) -> SyncReport {
    self.total_phases = total_phases;
    self
  }
  ...
  pub fn with_unchanged_data_bytes(mut self, unchanged_data_bytes: i32) -> SyncReport {
    self.unchanged_data_bytes = unchanged_data_bytes;
    self
  }
  ...
  pub fn with_up_to_date_files_skipped(mut self, up_to_date_files_skipped: i32) -> SyncReport {
    self.up_to_date_files_skipped = up_to_date_files_skipped;
    self
  }
  ...
  pub fn with_updated_files_replicated(mut self, updated_files_replicated: i32) -> SyncReport {
    self.updated_files_replicated = updated_files_replicated;
    self
  }
  ...
  pub fn with_user_conflict_files_skipped(mut self, user_conflict_files_skipped: i32) -> SyncReport {
    self.user_conflict_files_skipped = user_conflict_files_skipped;
    self
  }
  ...
  pub fn with_warnings(mut self, warnings: Vec<String>) -> SyncReport {
    self.warnings = warnings;
    self
  }
  ...
  pub fn with_worm_committed_file_conflicts(mut self, worm_committed_file_conflicts: i32) -> SyncReport {
    self.worm_committed_file_conflicts = worm_committed_file_conflicts;
    self
  }
