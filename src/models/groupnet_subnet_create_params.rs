...
impl GroupnetSubnetCreateParams {
  pub fn new(name: String, prefixlen: i32, addr_family: String) -> GroupnetSubnetCreateParams {
  ...
  pub fn with_description(mut self, description: String) -> GroupnetSubnetCreateParams {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_dsr_addrs(mut self, dsr_addrs: Vec<String>) -> GroupnetSubnetCreateParams {
    self.dsr_addrs = Some(dsr_addrs);
    self
  }
  ...
  pub fn with_gateway(mut self, gateway: String) -> GroupnetSubnetCreateParams {
    self.gateway = Some(gateway);
    self
  }
  ...
  pub fn with_gateway_priority(mut self, gateway_priority: i32) -> GroupnetSubnetCreateParams {
    self.gateway_priority = Some(gateway_priority);
    self
  }
  ...
  pub fn with_mtu(mut self, mtu: i32) -> GroupnetSubnetCreateParams {
    self.mtu = Some(mtu);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> GroupnetSubnetCreateParams {
    self.name = name;
    self
  }
  ...
  pub fn with_prefixlen(mut self, prefixlen: i32) -> GroupnetSubnetCreateParams {
    self.prefixlen = prefixlen;
    self
  }
  ...
  pub fn with_sc_service_addr(mut self, sc_service_addr: String) -> GroupnetSubnetCreateParams {
    self.sc_service_addr = Some(sc_service_addr);
    self
  }
  ...
  pub fn with_sc_service_name(mut self, sc_service_name: String) -> GroupnetSubnetCreateParams {
    self.sc_service_name = Some(sc_service_name);
    self
  }
  ...
  pub fn with_vlan_enabled(mut self, vlan_enabled: bool) -> GroupnetSubnetCreateParams {
    self.vlan_enabled = Some(vlan_enabled);
    self
  }
  ...
  pub fn with_vlan_id(mut self, vlan_id: i32) -> GroupnetSubnetCreateParams {
    self.vlan_id = Some(vlan_id);
    self
  }
  ...
  pub fn with_addr_family(mut self, addr_family: String) -> GroupnetSubnetCreateParams {
    self.addr_family = addr_family;
    self
  }
