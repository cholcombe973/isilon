...
impl EventChannelCreateParams {
  pub fn new(_type: String, name: String) -> EventChannelCreateParams {
  ...
  pub fn with_allowed_nodes(mut self, allowed_nodes: Vec<i32>) -> EventChannelCreateParams {
    self.allowed_nodes = Some(allowed_nodes);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> EventChannelCreateParams {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_excluded_nodes(mut self, excluded_nodes: Vec<i32>) -> EventChannelCreateParams {
    self.excluded_nodes = Some(excluded_nodes);
    self
  }
  ...
  pub fn with_parameters(mut self, parameters: ::models::EventChannelParameters) -> EventChannelCreateParams {
    self.parameters = Some(parameters);
    self
  }
  ...
  pub fn with_system(mut self, system: bool) -> EventChannelCreateParams {
    self.system = Some(system);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> EventChannelCreateParams {
    self._type = _type;
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> EventChannelCreateParams {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> EventChannelCreateParams {
    self.name = name;
    self
  }
