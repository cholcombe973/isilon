...
impl NodeStatus {
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> NodeStatus {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::NodeStatusNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::NodeStatusNode>) -> NodeStatus {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::NodeStatusNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> NodeStatus {
    self.total = Some(total);
    self
  }
