...
impl SubnetsSubnetPoolCreateParams {
  pub fn new(name: String) -> SubnetsSubnetPoolCreateParams {
  ...
  pub fn with_access_zone(mut self, access_zone: String) -> SubnetsSubnetPoolCreateParams {
    self.access_zone = Some(access_zone);
    self
  }
  ...
  pub fn with_aggregation_mode(mut self, aggregation_mode: String) -> SubnetsSubnetPoolCreateParams {
    self.aggregation_mode = Some(aggregation_mode);
    self
  }
  ...
  pub fn with_alloc_method(mut self, alloc_method: String) -> SubnetsSubnetPoolCreateParams {
    self.alloc_method = Some(alloc_method);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> SubnetsSubnetPoolCreateParams {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_ifaces(mut self, ifaces: Vec<::models::SubnetsSubnetPoolIface>) -> SubnetsSubnetPoolCreateParams {
    self.ifaces = Some(ifaces);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SubnetsSubnetPoolCreateParams {
    self.name = name;
    self
  }
  ...
  pub fn with_ranges(mut self, ranges: Vec<::models::SubnetsSubnetPoolRange>) -> SubnetsSubnetPoolCreateParams {
    self.ranges = Some(ranges);
    self
  }
  ...
  pub fn with_rebalance_policy(mut self, rebalance_policy: String) -> SubnetsSubnetPoolCreateParams {
    self.rebalance_policy = Some(rebalance_policy);
    self
  }
  ...
  pub fn with_sc_auto_unsuspend_delay(mut self, sc_auto_unsuspend_delay: i32) -> SubnetsSubnetPoolCreateParams {
    self.sc_auto_unsuspend_delay = Some(sc_auto_unsuspend_delay);
    self
  }
  ...
  pub fn with_sc_connect_policy(mut self, sc_connect_policy: String) -> SubnetsSubnetPoolCreateParams {
    self.sc_connect_policy = Some(sc_connect_policy);
    self
  }
  ...
  pub fn with_sc_dns_zone(mut self, sc_dns_zone: String) -> SubnetsSubnetPoolCreateParams {
    self.sc_dns_zone = Some(sc_dns_zone);
    self
  }
  ...
  pub fn with_sc_dns_zone_aliases(mut self, sc_dns_zone_aliases: Vec<String>) -> SubnetsSubnetPoolCreateParams {
    self.sc_dns_zone_aliases = Some(sc_dns_zone_aliases);
    self
  }
  ...
  pub fn with_sc_failover_policy(mut self, sc_failover_policy: String) -> SubnetsSubnetPoolCreateParams {
    self.sc_failover_policy = Some(sc_failover_policy);
    self
  }
  ...
  pub fn with_sc_subnet(mut self, sc_subnet: String) -> SubnetsSubnetPoolCreateParams {
    self.sc_subnet = Some(sc_subnet);
    self
  }
  ...
  pub fn with_sc_ttl(mut self, sc_ttl: i32) -> SubnetsSubnetPoolCreateParams {
    self.sc_ttl = Some(sc_ttl);
    self
  }
  ...
  pub fn with_static_routes(mut self, static_routes: Vec<::models::SubnetsSubnetPoolStaticRoute>) -> SubnetsSubnetPoolCreateParams {
    self.static_routes = Some(static_routes);
    self
  }
