...
impl HdfsRackCreateParams {
  pub fn new(name: String) -> HdfsRackCreateParams {
  ...
  pub fn with_client_ip_ranges(mut self, client_ip_ranges: Vec<String>) -> HdfsRackCreateParams {
    self.client_ip_ranges = Some(client_ip_ranges);
    self
  }
  ...
  pub fn with_ip_pools(mut self, ip_pools: Vec<String>) -> HdfsRackCreateParams {
    self.ip_pools = Some(ip_pools);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> HdfsRackCreateParams {
    self.name = name;
    self
  }
