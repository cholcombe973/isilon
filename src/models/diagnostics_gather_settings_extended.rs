...
impl DiagnosticsGatherSettingsExtended {
  pub fn new() -> DiagnosticsGatherSettingsExtended {
  ...
  pub fn with_esrs(mut self, esrs: bool) -> DiagnosticsGatherSettingsExtended {
    self.esrs = Some(esrs);
    self
  }
  ...
  pub fn with_ftp_upload(mut self, ftp_upload: bool) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload = Some(ftp_upload);
    self
  }
  ...
  pub fn with_ftp_upload_host(mut self, ftp_upload_host: String) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_host = Some(ftp_upload_host);
    self
  }
  ...
  pub fn with_ftp_upload_mode(mut self, ftp_upload_mode: String) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_mode = Some(ftp_upload_mode);
    self
  }
  ...
  pub fn with_ftp_upload_path(mut self, ftp_upload_path: String) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_path = Some(ftp_upload_path);
    self
  }
  ...
  pub fn with_ftp_upload_proxy(mut self, ftp_upload_proxy: String) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_proxy = Some(ftp_upload_proxy);
    self
  }
  ...
  pub fn with_ftp_upload_proxy_port(mut self, ftp_upload_proxy_port: i32) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_proxy_port = Some(ftp_upload_proxy_port);
    self
  }
  ...
  pub fn with_ftp_upload_user(mut self, ftp_upload_user: String) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_user = Some(ftp_upload_user);
    self
  }
  ...
  pub fn with_gather_mode(mut self, gather_mode: String) -> DiagnosticsGatherSettingsExtended {
    self.gather_mode = Some(gather_mode);
    self
  }
  ...
  pub fn with_http_upload(mut self, http_upload: bool) -> DiagnosticsGatherSettingsExtended {
    self.http_upload = Some(http_upload);
    self
  }
  ...
  pub fn with_http_upload_host(mut self, http_upload_host: String) -> DiagnosticsGatherSettingsExtended {
    self.http_upload_host = Some(http_upload_host);
    self
  }
  ...
  pub fn with_http_upload_path(mut self, http_upload_path: String) -> DiagnosticsGatherSettingsExtended {
    self.http_upload_path = Some(http_upload_path);
    self
  }
  ...
  pub fn with_http_upload_proxy(mut self, http_upload_proxy: String) -> DiagnosticsGatherSettingsExtended {
    self.http_upload_proxy = Some(http_upload_proxy);
    self
  }
  ...
  pub fn with_http_upload_proxy_port(mut self, http_upload_proxy_port: i32) -> DiagnosticsGatherSettingsExtended {
    self.http_upload_proxy_port = Some(http_upload_proxy_port);
    self
  }
  ...
  pub fn with_upload(mut self, upload: bool) -> DiagnosticsGatherSettingsExtended {
    self.upload = Some(upload);
    self
  }
  ...
  pub fn set_ftp_upload_pass(&mut self, ftp_upload_pass: String) {
    self.ftp_upload_pass = Some(ftp_upload_pass);
  }

  pub fn with_ftp_upload_pass(mut self, ftp_upload_pass: String) -> DiagnosticsGatherSettingsExtended {
    self.ftp_upload_pass = Some(ftp_upload_pass);
    self
  }

  pub fn ftp_upload_pass(&self) -> Option<&String> {
    self.ftp_upload_pass.as_ref()
  }

  pub fn reset_ftp_upload_pass(&mut self) {
    self.ftp_upload_pass = None;
  }
