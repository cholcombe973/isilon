...
impl CertificateServerIdParams {
  pub fn new() -> CertificateServerIdParams {
  ...
  pub fn with_default(mut self, default: bool) -> CertificateServerIdParams {
    self.default = Some(default);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> CertificateServerIdParams {
    self.description = Some(description);
    self
  }
