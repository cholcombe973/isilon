...
impl NfsAlias {
  ...
  pub fn with_health(mut self, health: String) -> NfsAlias {
    self.health = Some(health);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> NfsAlias {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> NfsAlias {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_zone(mut self, zone: String) -> NfsAlias {
    self.zone = Some(zone);
    self
  }
