...
impl GroupnetSubnetsExtended {
  pub fn new() -> GroupnetSubnetsExtended {
  ...
  pub fn with_subnets(mut self, subnets: Vec<::models::GroupnetSubnetExtended>) -> GroupnetSubnetsExtended {
    self.subnets = Some(subnets);
    self
  }
  ...
  pub fn with_resume(mut self, resume: String) -> GroupnetSubnetsExtended {
    self.resume = Some(resume);
    self
  }
  ...
  pub fn with_total(mut self, total: i32) -> GroupnetSubnetsExtended {
    self.total = Some(total);
    self
  }
