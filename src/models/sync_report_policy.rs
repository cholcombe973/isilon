...
impl SyncReportPolicy {
  pub fn new() -> SyncReportPolicy {
    SyncReportPolicy {
      action: None,
  ...
  pub fn with_action(mut self, action: String) -> SyncReportPolicy {
    self.action = Some(action);
    self
  }
  ...
  pub fn with_file_matching_pattern(mut self, file_matching_pattern: ::models::SyncJobPolicyFileMatchingPattern) -> SyncReportPolicy {
    self.file_matching_pattern = Some(file_matching_pattern);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SyncReportPolicy {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_source_exclude_directories(mut self, source_exclude_directories: Vec<String>) -> SyncReportPolicy {
    self.source_exclude_directories = Some(source_exclude_directories);
    self
  }
  ...
  pub fn with_source_include_directories(mut self, source_include_directories: Vec<String>) -> SyncReportPolicy {
    self.source_include_directories = Some(source_include_directories);
    self
  }
  ...
  pub fn with_source_root_path(mut self, source_root_path: String) -> SyncReportPolicy {
    self.source_root_path = Some(source_root_path);
    self
  }
  ...
  pub fn with_target_host(mut self, target_host: String) -> SyncReportPolicy {
    self.target_host = Some(target_host);
    self
  }
  ...
  pub fn with_target_path(mut self, target_path: String) -> SyncReportPolicy {
    self.target_path = Some(target_path);
    self
  }
