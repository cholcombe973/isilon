...
impl NodeStateSmartfail {
  pub fn new() -> NodeStateSmartfail {
    NodeStateSmartfail {
      errors: None,
      nodes: None,
      total: None
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> NodeStateSmartfail {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::NodeStateSmartfailNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::NodeStateSmartfailNode>) -> NodeStateSmartfail {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::NodeStateSmartfailNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> NodeStateSmartfail {
    self.total = Some(total);
    self
  }
