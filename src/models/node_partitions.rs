...
impl NodePartitions {
  ...
  pub fn with_errors(mut self, errors: Vec<::models::NodeDrivesPurposelistError>) -> NodePartitions {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn set_nodes(&mut self, nodes: Vec<::models::NodePartitionsNode>) {
    self.nodes = Some(nodes);
  }

  pub fn with_nodes(mut self, nodes: Vec<::models::NodePartitionsNode>) -> NodePartitions {
    self.nodes = Some(nodes);
    self
  }

  pub fn nodes(&self) -> Option<&Vec<::models::NodePartitionsNode>> {
    self.nodes.as_ref()
  }
  ...
  pub fn with_total(mut self, total: i32) -> NodePartitions {
    self.total = Some(total);
    self
  }
