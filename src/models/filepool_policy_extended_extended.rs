...
impl FilepoolPolicyExtendedExtended {
  pub fn new() -> FilepoolPolicyExtendedExtended {
  ...
  pub fn set_actions(&mut self, actions: Vec<::models::FilepoolPolicyActionExtended>) {
    self.actions = Some(actions);
  }

  pub fn with_actions(mut self, actions: Vec<::models::FilepoolPolicyActionExtended>) -> FilepoolPolicyExtendedExtended {
    self.actions = Some(actions);
    self
  }

  pub fn actions(&self) -> Option<&Vec<::models::FilepoolPolicyActionExtended>> {
    self.actions.as_ref()
  }
  ...
  pub fn with_apply_order(mut self, apply_order: i32) -> FilepoolPolicyExtendedExtended {
    self.apply_order = Some(apply_order);
    self
  }
  ...
  pub fn with_birth_cluster_id(mut self, birth_cluster_id: String) -> FilepoolPolicyExtendedExtended {
    self.birth_cluster_id = Some(birth_cluster_id);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> FilepoolPolicyExtendedExtended {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_file_matching_pattern(mut self, file_matching_pattern: ::models::FilepoolPolicyFileMatchingPattern) -> FilepoolPolicyExtendedExtended {
    self.file_matching_pattern = Some(file_matching_pattern);
    self
  }
  ...
  pub fn with_id(mut self, id: i32) -> FilepoolPolicyExtendedExtended {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> FilepoolPolicyExtendedExtended {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> FilepoolPolicyExtendedExtended {
    self.state = Some(state);
    self
  }
  ...
  pub fn with_state_details(mut self, state_details: String) -> FilepoolPolicyExtendedExtended {
    self.state_details = Some(state_details);
    self
  }
