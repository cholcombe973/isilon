...
impl SyncPolicyExtendedExtended {
  pub fn new(enabled: bool, id: String, name: String, schedule: String, source_root_path: String, target_host: String, target_path: String) -> SyncPolicyExtendedExtended {
  ...
  pub fn with_accelerated_failback(mut self, accelerated_failback: bool) -> SyncPolicyExtendedExtended {
    self.accelerated_failback = Some(accelerated_failback);
    self
  }
  ...
  pub fn with_action(mut self, action: String) -> SyncPolicyExtendedExtended {
    self.action = Some(action);
    self
  }
  ...
  pub fn with_burst_mode(mut self, burst_mode: bool) -> SyncPolicyExtendedExtended {
    self.burst_mode = Some(burst_mode);
    self
  }
  ...
  pub fn with_changelist(mut self, changelist: bool) -> SyncPolicyExtendedExtended {
    self.changelist = Some(changelist);
    self
  }
  ...
  pub fn with_check_integrity(mut self, check_integrity: bool) -> SyncPolicyExtendedExtended {
    self.check_integrity = Some(check_integrity);
    self
  }
  ...
  pub fn with_cloud_deep_copy(mut self, cloud_deep_copy: String) -> SyncPolicyExtendedExtended {
    self.cloud_deep_copy = Some(cloud_deep_copy);
    self
  }
  ...
  pub fn with_conflicted(mut self, conflicted: bool) -> SyncPolicyExtendedExtended {
    self.conflicted = Some(conflicted);
    self
  }

  pub fn conflicted(&self) -> Option<&bool> {
    self.conflicted.as_ref()
  }

  pub fn reset_conflicted(&mut self) {
  ...
  pub fn with_description(mut self, description: String) -> SyncPolicyExtendedExtended {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_disable_file_split(mut self, disable_file_split: bool) -> SyncPolicyExtendedExtended {
    self.disable_file_split = Some(disable_file_split);
    self
  }
  ...
  pub fn with_disable_fofb(mut self, disable_fofb: bool) -> SyncPolicyExtendedExtended {
    self.disable_fofb = Some(disable_fofb);
    self
  }
  ...
  pub fn with_disable_stf(mut self, disable_stf: bool) -> SyncPolicyExtendedExtended {
    self.disable_stf = Some(disable_stf);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> SyncPolicyExtendedExtended {
    self.enabled = enabled;
    self
  }
  ...
  pub fn with_expected_dataloss(mut self, expected_dataloss: bool) -> SyncPolicyExtendedExtended {
    self.expected_dataloss = Some(expected_dataloss);
    self
  }
  ...
  pub fn with_file_matching_pattern(mut self, file_matching_pattern: ::models::SyncJobPolicyFileMatchingPattern) -> SyncPolicyExtendedExtended {
    self.file_matching_pattern = Some(file_matching_pattern);
    self
  }
  ...
  pub fn with_force_interface(mut self, force_interface: bool) -> SyncPolicyExtendedExtended {
    self.force_interface = Some(force_interface);
    self
  }
  ...
  pub fn set_has_sync_state(&mut self, has_sync_state: bool) {
    self.has_sync_state = Some(has_sync_state);
  }

  pub fn with_has_sync_state(mut self, has_sync_state: bool) -> SyncPolicyExtendedExtended {
    self.has_sync_state = Some(has_sync_state);
    self
  }

  pub fn has_sync_state(&self) -> Option<&bool> {
    self.has_sync_state.as_ref()
  }

  pub fn reset_has_sync_state(&mut self) {
    self.has_sync_state = None;
  }
  ...
  pub fn with_id(mut self, id: String) -> SyncPolicyExtendedExtended {
    self.id = id;
    self
  }
  ...
  pub fn with_job_delay(mut self, job_delay: i32) -> SyncPolicyExtendedExtended {
    self.job_delay = Some(job_delay);
    self
  }
  ...
  pub fn set_last_job_state(&mut self, last_job_state: String) {
    self.last_job_state = Some(last_job_state);
  }

  pub fn with_last_job_state(mut self, last_job_state: String) -> SyncPolicyExtendedExtended {
    self.last_job_state = Some(last_job_state);
    self
  }

  pub fn last_job_state(&self) -> Option<&String> {
    self.last_job_state.as_ref()
  }

  pub fn reset_last_job_state(&mut self) {
    self.last_job_state = None;
  }
  ...
  pub fn with_last_started(mut self, last_started: i32) -> SyncPolicyExtendedExtended {
    self.last_started = Some(last_started);
    self
  }
  ...
  pub fn with_last_success(mut self, last_success: i32) -> SyncPolicyExtendedExtended {
    self.last_success = Some(last_success);
    self
  }
  ...
  pub fn with_log_level(mut self, log_level: String) -> SyncPolicyExtendedExtended {
    self.log_level = Some(log_level);
    self
  }
  ...
  pub fn with_log_removed_files(mut self, log_removed_files: bool) -> SyncPolicyExtendedExtended {
    self.log_removed_files = Some(log_removed_files);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SyncPolicyExtendedExtended {
    self.name = name;
    self
  }
  ...
  pub fn with_next_run(mut self, next_run: i32) -> SyncPolicyExtendedExtended {
    self.next_run = Some(next_run);
    self
  }
  ...
  pub fn with_password_set(mut self, password_set: bool) -> SyncPolicyExtendedExtended {
    self.password_set = Some(password_set);
    self
  }

  pub fn password_set(&self) -> Option<&bool> {
    self.password_set.as_ref()
  }

  pub fn reset_password_set(&mut self) {
  ...
  pub fn with_priority(mut self, priority: i32) -> SyncPolicyExtendedExtended {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_report_max_age(mut self, report_max_age: i32) -> SyncPolicyExtendedExtended {
    self.report_max_age = Some(report_max_age);
    self
  }
  ...
  pub fn with_report_max_count(mut self, report_max_count: i32) -> SyncPolicyExtendedExtended {
    self.report_max_count = Some(report_max_count);
    self
  }
  ...
  pub fn with_restrict_target_network(mut self, restrict_target_network: bool) -> SyncPolicyExtendedExtended {
    self.restrict_target_network = Some(restrict_target_network);
    self
  }
  ...
  pub fn with_rpo_alert(mut self, rpo_alert: i32) -> SyncPolicyExtendedExtended {
    self.rpo_alert = Some(rpo_alert);
    self
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> SyncPolicyExtendedExtended {
    self.schedule = schedule;
    self
  }
  ...
  pub fn with_skip_lookup(mut self, skip_lookup: bool) -> SyncPolicyExtendedExtended {
    self.skip_lookup = Some(skip_lookup);
    self
  }
  ...
  pub fn with_skip_when_source_unmodified(mut self, skip_when_source_unmodified: bool) -> SyncPolicyExtendedExtended {
    self.skip_when_source_unmodified = Some(skip_when_source_unmodified);
    self
  }
  ...
  pub fn with_snapshot_sync_existing(mut self, snapshot_sync_existing: bool) -> SyncPolicyExtendedExtended {
    self.snapshot_sync_existing = Some(snapshot_sync_existing);
    self
  }
  ...
  pub fn with_snapshot_sync_pattern(mut self, snapshot_sync_pattern: String) -> SyncPolicyExtendedExtended {
    self.snapshot_sync_pattern = Some(snapshot_sync_pattern);
    self
  }
  ...
  pub fn with_source_exclude_directories(mut self, source_exclude_directories: Vec<String>) -> SyncPolicyExtendedExtended {
    self.source_exclude_directories = Some(source_exclude_directories);
    self
  }
  ...
  pub fn with_source_include_directories(mut self, source_include_directories: Vec<String>) -> SyncPolicyExtendedExtended {
    self.source_include_directories = Some(source_include_directories);
    self
  }
  ...
  pub fn with_source_network(mut self, source_network: ::models::SyncPolicySourceNetwork) -> SyncPolicyExtendedExtended {
    self.source_network = Some(source_network);
    self
  }
  ...
  pub fn with_source_root_path(mut self, source_root_path: String) -> SyncPolicyExtendedExtended {
    self.source_root_path = source_root_path;
    self
  }
  ...
  pub fn with_source_snapshot_archive(mut self, source_snapshot_archive: bool) -> SyncPolicyExtendedExtended {
    self.source_snapshot_archive = Some(source_snapshot_archive);
    self
  }
  ...
  pub fn with_source_snapshot_expiration(mut self, source_snapshot_expiration: i32) -> SyncPolicyExtendedExtended {
    self.source_snapshot_expiration = Some(source_snapshot_expiration);
    self
  }
  ...
  pub fn with_source_snapshot_pattern(mut self, source_snapshot_pattern: String) -> SyncPolicyExtendedExtended {
    self.source_snapshot_pattern = Some(source_snapshot_pattern);
    self
  }
  ...
  pub fn with_target_compare_initial_sync(mut self, target_compare_initial_sync: bool) -> SyncPolicyExtendedExtended {
    self.target_compare_initial_sync = Some(target_compare_initial_sync);
    self
  }
  ...
  pub fn with_target_detect_modifications(mut self, target_detect_modifications: bool) -> SyncPolicyExtendedExtended {
    self.target_detect_modifications = Some(target_detect_modifications);
    self
  }
  ...
  pub fn with_target_host(mut self, target_host: String) -> SyncPolicyExtendedExtended {
    self.target_host = target_host;
    self
  }
  ...
  pub fn with_target_path(mut self, target_path: String) -> SyncPolicyExtendedExtended {
    self.target_path = target_path;
    self
  }
  ...
  pub fn with_target_snapshot_alias(mut self, target_snapshot_alias: String) -> SyncPolicyExtendedExtended {
    self.target_snapshot_alias = Some(target_snapshot_alias);
    self
  }
  ...
  pub fn with_target_snapshot_archive(mut self, target_snapshot_archive: bool) -> SyncPolicyExtendedExtended {
    self.target_snapshot_archive = Some(target_snapshot_archive);
    self
  }
  ...
  pub fn with_target_snapshot_expiration(mut self, target_snapshot_expiration: i32) -> SyncPolicyExtendedExtended {
    self.target_snapshot_expiration = Some(target_snapshot_expiration);
    self
  }
  ...
  pub fn with_target_snapshot_pattern(mut self, target_snapshot_pattern: String) -> SyncPolicyExtendedExtended {
    self.target_snapshot_pattern = Some(target_snapshot_pattern);
    self
  }
  ...
  pub fn with_workers_per_node(mut self, workers_per_node: i32) -> SyncPolicyExtendedExtended {
    self.workers_per_node = Some(workers_per_node);
    self
  }
