...
impl ProvidersNisNisItemExtended {
  pub fn new() -> ProvidersNisNisItemExtended {
  ...
  pub fn with_authentication(mut self, authentication: bool) -> ProvidersNisNisItemExtended {
    self.authentication = Some(authentication);
    self
  }
  ...
  pub fn with_balance_servers(mut self, balance_servers: bool) -> ProvidersNisNisItemExtended {
    self.balance_servers = Some(balance_servers);
    self
  }
  ...
  pub fn with_check_online_interval(mut self, check_online_interval: i32) -> ProvidersNisNisItemExtended {
    self.check_online_interval = Some(check_online_interval);
    self
  }
  ...
  pub fn with_create_home_directory(mut self, create_home_directory: bool) -> ProvidersNisNisItemExtended {
    self.create_home_directory = Some(create_home_directory);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> ProvidersNisNisItemExtended {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_enumerate_groups(mut self, enumerate_groups: bool) -> ProvidersNisNisItemExtended {
    self.enumerate_groups = Some(enumerate_groups);
    self
  }
  ...
  pub fn with_enumerate_users(mut self, enumerate_users: bool) -> ProvidersNisNisItemExtended {
    self.enumerate_users = Some(enumerate_users);
    self
  }
  ...
  pub fn with_findable_groups(mut self, findable_groups: Vec<String>) -> ProvidersNisNisItemExtended {
    self.findable_groups = Some(findable_groups);
    self
  }
  ...
  pub fn with_findable_users(mut self, findable_users: Vec<String>) -> ProvidersNisNisItemExtended {
    self.findable_users = Some(findable_users);
    self
  }
  ...
  pub fn with_group_domain(mut self, group_domain: String) -> ProvidersNisNisItemExtended {
    self.group_domain = Some(group_domain);
    self
  }
  ...
  pub fn with_home_directory_template(mut self, home_directory_template: String) -> ProvidersNisNisItemExtended {
    self.home_directory_template = Some(home_directory_template);
    self
  }
  ...
  pub fn with_hostname_lookup(mut self, hostname_lookup: bool) -> ProvidersNisNisItemExtended {
    self.hostname_lookup = Some(hostname_lookup);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> ProvidersNisNisItemExtended {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_listable_groups(mut self, listable_groups: Vec<String>) -> ProvidersNisNisItemExtended {
    self.listable_groups = Some(listable_groups);
    self
  }
  ...
  pub fn with_listable_users(mut self, listable_users: Vec<String>) -> ProvidersNisNisItemExtended {
    self.listable_users = Some(listable_users);
    self
  }
  ...
  pub fn with_login_shell(mut self, login_shell: String) -> ProvidersNisNisItemExtended {
    self.login_shell = Some(login_shell);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ProvidersNisNisItemExtended {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_nis_domain(mut self, nis_domain: String) -> ProvidersNisNisItemExtended {
    self.nis_domain = Some(nis_domain);
    self
  }
  ...
  pub fn with_normalize_groups(mut self, normalize_groups: bool) -> ProvidersNisNisItemExtended {
    self.normalize_groups = Some(normalize_groups);
    self
  }
  ...
  pub fn with_normalize_users(mut self, normalize_users: bool) -> ProvidersNisNisItemExtended {
    self.normalize_users = Some(normalize_users);
    self
  }
  ...
  pub fn with_ntlm_support(mut self, ntlm_support: String) -> ProvidersNisNisItemExtended {
    self.ntlm_support = Some(ntlm_support);
    self
  }
  ...
  pub fn with_provider_domain(mut self, provider_domain: String) -> ProvidersNisNisItemExtended {
    self.provider_domain = Some(provider_domain);
    self
  }
  ...
  pub fn with_request_timeout(mut self, request_timeout: i32) -> ProvidersNisNisItemExtended {
    self.request_timeout = Some(request_timeout);
    self
  }
  ...
  pub fn with_restrict_findable(mut self, restrict_findable: bool) -> ProvidersNisNisItemExtended {
    self.restrict_findable = Some(restrict_findable);
    self
  }
  ...
  pub fn with_restrict_listable(mut self, restrict_listable: bool) -> ProvidersNisNisItemExtended {
    self.restrict_listable = Some(restrict_listable);
    self
  }
  ...
  pub fn with_retry_time(mut self, retry_time: i32) -> ProvidersNisNisItemExtended {
    self.retry_time = Some(retry_time);
    self
  }
  ...
  pub fn with_servers(mut self, servers: Vec<String>) -> ProvidersNisNisItemExtended {
    self.servers = Some(servers);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> ProvidersNisNisItemExtended {
    self.status = Some(status);
    self
  }
  ...
  pub fn with_system(mut self, system: bool) -> ProvidersNisNisItemExtended {
    self.system = Some(system);
    self
  }
  ...
  pub fn with_unfindable_groups(mut self, unfindable_groups: Vec<String>) -> ProvidersNisNisItemExtended {
    self.unfindable_groups = Some(unfindable_groups);
    self
  }
  ...
  pub fn with_unfindable_users(mut self, unfindable_users: Vec<String>) -> ProvidersNisNisItemExtended {
    self.unfindable_users = Some(unfindable_users);
    self
  }
  ...
  pub fn with_unlistable_groups(mut self, unlistable_groups: Vec<String>) -> ProvidersNisNisItemExtended {
    self.unlistable_groups = Some(unlistable_groups);
    self
  }
  ...
  pub fn with_unlistable_users(mut self, unlistable_users: Vec<String>) -> ProvidersNisNisItemExtended {
    self.unlistable_users = Some(unlistable_users);
    self
  }
  ...
  pub fn with_user_domain(mut self, user_domain: String) -> ProvidersNisNisItemExtended {
    self.user_domain = Some(user_domain);
    self
  }
  ...
  pub fn with_ypmatch_using_tcp(mut self, ypmatch_using_tcp: bool) -> ProvidersNisNisItemExtended {
    self.ypmatch_using_tcp = Some(ypmatch_using_tcp);
    self
  }
  ...
  pub fn with_groupnet(mut self, groupnet: String) -> ProvidersNisNisItemExtended {
    self.groupnet = Some(groupnet);
    self
  }
